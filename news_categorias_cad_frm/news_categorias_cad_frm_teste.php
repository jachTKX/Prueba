<?php  
  ...
  session_start() ;
  class news_categorias_cad_frm_form_teste
  {
   function news_categorias_cad_frm_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "news_categorias_cad_frm/img";
...
?> 
<br> 
<B><FONT SIZE="4">news_categorias_cad_frm</FONT></B> 
<br> 
<br> 
...
categoria_id&nbsp;&nbsp;<input type=text name=categoria_id size=20><br> 
<input type="submit" value="news_categorias_cad_frm"> 
</form> 
<script language=javascript> 
 document.Fedit.categoria_id.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new news_categorias_cad_frm_form_teste();
  $frm_teste->news_categorias_cad_frm_teste();
?>
