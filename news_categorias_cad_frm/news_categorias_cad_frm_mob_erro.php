...
$old_error_handler = set_error_handler("news_categorias_cad_frm_mob_scriptcase_error_handler");

function news_categorias_cad_frm_mob_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['news_categorias_cad_frm_mob']['contr_erro']) && $_SESSION['scriptcase']['news_categorias_cad_frm_mob']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_news_categorias_cad_frm_mob->contr_news_categorias_cad_frm_mob->Apl_com_erro = true;
            if ($inicial_news_categorias_cad_frm_mob->contr_news_categorias_cad_frm_mob->NM_ajax_flag)
            {
                $inicial_news_categorias_cad_frm_mob->contr_news_categorias_cad_frm_mob->NM_ajax_info['errList']['geral_news_categorias_cad_frm_mob'][] = $msg;
                return;
            }
            news_categorias_cad_frm_mob_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function news_categorias_cad_frm_mob_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['news_categorias_cad_frm_mob'])  && '' != $_SESSION['scriptcase']['error_icon']['news_categorias_cad_frm_mob'])  ? $_SESSION['scriptcase']['error_icon']['news_categorias_cad_frm_mob']  : "";
        $sCloseIcon      = (isset($_SESSION['scriptcase']['error_close']['news_categorias_cad_frm_mob']) && '' != $_SESSION['scriptcase']['error_close']['news_categorias_cad_frm_mob']) ? $_SESSION['scriptcase']['error_close']['news_categorias_cad_frm_mob'] : "<td><input class=\"scButton_default\" type=\"button\" onClick=\"document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false\" value=\"X\" /></td>";

        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['news_categorias_cad_frm_mob']) && '' != $_SESSION['scriptcase']['error_span_title']['news_categorias_cad_frm_mob']) ? $_SESSION['scriptcase']['error_span_title']['news_categorias_cad_frm_mob'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['news_categorias_cad_frm_mob']) && '' != $_SESSION['scriptcase']['error_icon_title']['news_categorias_cad_frm_mob']) ? $_SESSION['scriptcase']['error_icon_title']['news_categorias_cad_frm_mob'] : '';
?>
...
<?php
    ...
    $_SESSION['scriptcase']['news_categorias_cad_frm']['error_buffer'] .= ob_get_flush();
}
