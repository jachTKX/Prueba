  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_categorias_cad_frm" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_categorias_cad_frm_form();
	}
  ...
  function do_ajax_news_categorias_cad_frm_validate_categoria_nome()
  {
    var nomeCampo_categoria_nome = "categoria_nome";
    var var_categoria_nome = scAjaxGetFieldText(nomeCampo_categoria_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_categorias_cad_frm_validate_categoria_nome(var_categoria_nome, var_script_case_init, do_ajax_news_categorias_cad_frm_validate_categoria_nome_cb);
  } // do_ajax_news_categorias_cad_frm_validate_categoria_nome

  function do_ajax_news_categorias_cad_frm_validate_categoria_nome_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_categorias_cad_frm_validate_categoria_nome_cb

  // ---------- Validate categoris_descricao
  function do_ajax_news_categorias_cad_frm_validate_categoris_descricao()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_categorias_cad_frm_validate_categoris_descricao(var_categoris_descricao, var_script_case_init, do_ajax_news_categorias_cad_frm_validate_categoris_descricao_cb);
  } // do_ajax_news_categorias_cad_frm_validate_categoris_descricao

  function do_ajax_news_categorias_cad_frm_validate_categoris_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_categorias_cad_frm_validate_categoris_descricao_cb

  // ---------- Validate categoria_editor
  function do_ajax_news_categorias_cad_frm_validate_categoria_editor()
  {
    var nomeCampo_categoria_editor = "categoria_editor";
    var var_categoria_editor = scAjaxGetFieldSelect(nomeCampo_categoria_editor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_categorias_cad_frm_validate_categoria_editor(var_categoria_editor, var_script_case_init, do_ajax_news_categorias_cad_frm_validate_categoria_editor_cb);
  } // do_ajax_news_categorias_cad_frm_validate_categoria_editor

  function do_ajax_news_categorias_cad_frm_validate_categoria_editor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_categorias_cad_frm_validate_categoria_editor_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_categorias_cad_frm_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_categorias_cad_frm_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_news_categorias_cad_frm_submit_form(var_categoria_nome, var_categoris_descricao, var_categoria_editor, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_categorias_cad_frm_submit_form_cb);
  } // do_ajax_news_categorias_cad_frm_submit_form

  function do_ajax_news_categorias_cad_frm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_categorias_cad_frm_submit_form_cb_after_alert);
  } // do_ajax_news_categorias_cad_frm_submit_form_cb
  function do_ajax_news_categorias_cad_frm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_categorias_cad_frm_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_categorias_cad_frm_navigate_form()
  {
    perform_ajax_news_categorias_cad_frm_navigate_form();
  }

  function perform_ajax_news_categorias_cad_frm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_news_categorias_cad_frm_navigate_form(var_categoria_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_news_categorias_cad_frm_navigate_form_cb);
  } // do_ajax_news_categorias_cad_frm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_categorias_cad_frm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_categorias_cad_frm_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_categorias_cad_frm_navigate_form_cb_after_alert);
  } // do_ajax_news_categorias_cad_frm_navigate_form_cb
  function do_ajax_news_categorias_cad_frm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_categorias_cad_frm_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_news_categorias_cad_frm_navigate_form_cb_after_alert
  function sc_hide_news_categorias_cad_frm_form()
  {
