  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_categorias_cad_frm_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_categorias_cad_frm_mob_form();
	}
  ...
  // ---------- Validate categoria_nome
  function do_ajax_news_categorias_cad_frm_mob_validate_categoria_nome()
  {
    var nomeCampo_categoria_nome = "categoria_nome";
    var var_categoria_nome = scAjaxGetFieldText(nomeCampo_categoria_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_categorias_cad_frm_mob_validate_categoria_nome(var_categoria_nome, var_script_case_init, do_ajax_news_categorias_cad_frm_mob_validate_categoria_nome_cb);
  } // do_ajax_news_categorias_cad_frm_mob_validate_categoria_nome

  function do_ajax_news_categorias_cad_frm_mob_validate_categoria_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categoria_nome";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_categorias_cad_frm_mob_validate_categoria_nome_cb

  // ---------- Validate categoris_descricao
  function do_ajax_news_categorias_cad_frm_mob_validate_categoris_descricao()
  {
    var nomeCampo_categoris_descricao = "categoris_descricao";
    var var_categoris_descricao = scAjaxGetFieldText(nomeCampo_categoris_descricao);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_categorias_cad_frm_mob_validate_categoris_descricao(var_categoris_descricao, var_script_case_init, do_ajax_news_categorias_cad_frm_mob_validate_categoris_descricao_cb);
  } // do_ajax_news_categorias_cad_frm_mob_validate_categoris_descricao

  function do_ajax_news_categorias_cad_frm_mob_validate_categoris_descricao_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categoris_descricao";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_categorias_cad_frm_mob_validate_categoris_descricao_cb

  // ---------- Validate categoria_editor
  function do_ajax_news_categorias_cad_frm_mob_validate_categoria_editor()
  {
    var nomeCampo_categoria_editor = "categoria_editor";
    var var_categoria_editor = scAjaxGetFieldSelect(nomeCampo_categoria_editor);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_categorias_cad_frm_mob_validate_categoria_editor(var_categoria_editor, var_script_case_init, do_ajax_news_categorias_cad_frm_mob_validate_categoria_editor_cb);
  } // do_ajax_news_categorias_cad_frm_mob_validate_categoria_editor

  function do_ajax_news_categorias_cad_frm_mob_validate_categoria_editor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categoria_editor";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_categorias_cad_frm_mob_validate_categoria_editor_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_categorias_cad_frm_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_categorias_cad_frm_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_categoria_nome = scAjaxGetFieldText("categoria_nome");
    var var_categoris_descricao = scAjaxGetFieldText("categoris_descricao");
    var var_categoria_editor = scAjaxGetFieldSelect("categoria_editor");
    var var_categoria_id = scAjaxGetFieldText("categoria_id");
    ...
    scAjaxProcOn();
    x_ajax_news_categorias_cad_frm_mob_submit_form(var_categoria_nome, var_categoris_descricao, var_categoria_editor, var_categoria_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_categorias_cad_frm_mob_submit_form_cb);
  } // do_ajax_news_categorias_cad_frm_mob_submit_form

  function do_ajax_news_categorias_cad_frm_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("categoria_nome");
      scAjaxHideErrorDisplay("categoris_descricao");
      scAjaxHideErrorDisplay("categoria_editor");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_categorias_cad_frm_mob_submit_form_cb_after_alert);
  } // do_ajax_news_categorias_cad_frm_mob_submit_form_cb
  function do_ajax_news_categorias_cad_frm_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_categorias_cad_frm_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_categorias_cad_frm_mob_navigate_form()
  {
    perform_ajax_news_categorias_cad_frm_mob_navigate_form();
  }

  function perform_ajax_news_categorias_cad_frm_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("categoris_descricao");
    scAjaxHideErrorDisplay("categoria_editor");
    var var_categoria_id = document.F2.categoria_id.value;
    ...
    scAjaxProcOn();
    x_ajax_news_categorias_cad_frm_mob_navigate_form(var_categoria_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_news_categorias_cad_frm_mob_navigate_form_cb);
  } // do_ajax_news_categorias_cad_frm_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_categorias_cad_frm_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_categorias_cad_frm_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.categoria_id.value = scAjaxGetKeyValue("categoria_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_categorias_cad_frm_mob_navigate_form_cb_after_alert);
  } // do_ajax_news_categorias_cad_frm_mob_navigate_form_cb
  function do_ajax_news_categorias_cad_frm_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_categorias_cad_frm_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_news_categorias_cad_frm_mob_navigate_form_cb_after_alert
  function sc_hide_news_categorias_cad_frm_mob_form()
  {
  ...
  ajax_field_list[0] = "categoria_nome";
  ajax_field_list[1] = "categoris_descricao";
  ajax_field_list[2] = "categoria_editor";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "categoria_nome": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_categorias_fild_categoria_nome'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "categoris_descricao": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_categorias_fild_categoris_descricao'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "categoria_editor": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_categorias_fild_categoria_editor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "categoria_nome": new Array(),
    "categoris_descricao": new Array(),
    "categoria_editor": new Array()
  };
  ajax_field_mult["categoria_nome"][1] = "categoria_nome";
  ajax_field_mult["categoris_descricao"][1] = "categoris_descricao";
  ajax_field_mult["categoria_editor"][1] = "categoria_editor";

  var ajax_field_id = {
    "categoria_nome": new Array("hidden_field_label_categoria_nome", "hidden_field_data_categoria_nome"),
    "categoris_descricao": new Array("hidden_field_label_categoris_descricao", "hidden_field_data_categoris_descricao"),
    "categoria_editor": new Array("hidden_field_label_categoria_editor", "hidden_field_data_categoria_editor")
  };

  var ajax_read_only = {
    "categoria_nome": "off",
    "categoris_descricao": "off",
    "categoria_editor": "off"
  };
