...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "categoria_id";$Nm_numeric[] = "categoria_id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_categoria_nome_cond" name="categoria_nome_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoria_nome'), this, 'categoria_nome')">
       <OPTION value="qp" <?php if ("qp" == $categoria_nome_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_categoria_nome"  <?php echo $str_hide_categoria_nome?>><INPUT  type="text" id="SC_categoria_nome" name="categoria_nome" value="<?php echo NM_encode_input($categoria_nome) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_categoris_descricao_cond" name="categoris_descricao_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoris_descricao'), this, 'categoris_descricao')">
       <OPTION value="qp" <?php if ("qp" == $categoris_descricao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_categoris_descricao"  <?php echo $str_hide_categoris_descricao?>><INPUT  type="text" id="SC_categoris_descricao" name="categoris_descricao" value="<?php echo NM_encode_input($categoris_descricao) ?>"  size=75 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
