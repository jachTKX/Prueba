<?php
@session_start() ;
$_SESSION['scriptcase']['news_editorial_list_categ_cons_new']['sc_process_barr'] = true;
require_once('../news_editorial_list_categ_cons_new/index.php');
unset($_SESSION['scriptcase']['news_editorial_list_categ_cons_new']['sc_process_barr']);
$ExportCtrl = new news_editorial_list_categ_cons_new_export_control;
$ExportCtrl->Export_barr();

class news_editorial_list_categ_cons_new_export_control
{
