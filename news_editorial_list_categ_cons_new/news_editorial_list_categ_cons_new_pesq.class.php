...
class news_editorial_list_categ_cons_new_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "news_editorial_list_categ_cons_new.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_tble_news_categorias'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>news_editorial_list_categ_cons_new/news_editorial_list_categ_cons_new_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="news_editorial_list_categ_cons_new_ajax_search.js"></script>
 <script type="text/javascript" src="news_editorial_list_categ_cons_new_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="news_editorial_list_categ_cons_new_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['news_editorial_list_categ_cons_new']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['news_editorial_list_categ_cons_new']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="news_editorial_list_categ_cons_new.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $categoria_nome_cond, $categoria_nome,
             $categoris_descricao_cond, $categoris_descricao,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!isset($categoria_nome_cond) || empty($categoria_nome_cond))
      {
         $categoria_nome_cond = "qp";
      }
      if (!isset($categoris_descricao_cond) || empty($categoris_descricao_cond))
      {
         $categoris_descricao_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_categoria_nome = (in_array($categoria_nome_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_categoris_descricao = (in_array($categoris_descricao_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($categoria_nome) || $categoria_nome == "")
      {
          $categoria_nome = "";
      }
      if (isset($categoria_nome) && !empty($categoria_nome))
      {
         $tmp_pos = strpos($categoria_nome, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $categoria_nome = substr($categoria_nome, 0, $tmp_pos);
         }
      }
      if (!isset($categoris_descricao) || $categoris_descricao == "")
      {
          $categoris_descricao = "";
      }
      if (isset($categoris_descricao) && !empty($categoris_descricao))
      {
         $tmp_pos = strpos($categoris_descricao, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $categoris_descricao = substr($categoris_descricao, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
...
?>
    ...
    <TR>
     <TD colspan="3" height="" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_0"><?php echo $Img_tit_blk_i ?>Filter<?php echo $Img_tit_blk_f ?></TD>
      ...
      <TD id='SC_categoria_nome_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['categoria_nome'])) ? $this->New_label['categoria_nome'] : "" . $this->Ini->Nm_lang['lang_news_categorias_fild_categoria_nome'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_categoria_nome_cond" name="categoria_nome_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoria_nome'), this, 'categoria_nome')">
       <OPTION value="qp" <?php if ("qp" == $categoria_nome_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_categoria_nome" <?php echo $str_hide_categoria_nome?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['categoria_nome'])) ? $this->New_label['categoria_nome'] : "" . $this->Ini->Nm_lang['lang_news_categorias_fild_categoria_nome'] . "";
 $nmgp_tab_label .= "categoria_nome?#?" . $SC_Label . "?@?";
 $date_sep_bw = " até ";
...
?>
<INPUT  type="text" id="SC_categoria_nome" name="categoria_nome" value="<?php echo NM_encode_input($categoria_nome) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_categoris_descricao_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['categoris_descricao'])) ? $this->New_label['categoris_descricao'] : "" . $this->Ini->Nm_lang['lang_news_categorias_fild_categoris_descricao'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_categoris_descricao_cond" name="categoris_descricao_cond" onChange="nm_campos_between(document.getElementById('id_vis_categoris_descricao'), this, 'categoris_descricao')">
       <OPTION value="qp" <?php if ("qp" == $categoris_descricao_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_categoris_descricao" <?php echo $str_hide_categoris_descricao?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['categoris_descricao'])) ? $this->New_label['categoris_descricao'] : "" . $this->Ini->Nm_lang['lang_news_categorias_fild_categoris_descricao'] . "";
 $nmgp_tab_label .= "categoris_descricao?#?" . $SC_Label . "?@?";
 $date_sep_bw = " até ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_categoris_descricao" name="categoris_descricao" value="<?php echo NM_encode_input($categoris_descricao) ?>"  size=75 alt="{datatype: 'text', maxLength: 255, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("news_editorial_list_categ_cons_new_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['news_editorial_list_categ_cons_new']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['news_editorial_list_categ_cons_new']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="news_editorial_list_categ_cons_new.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 function nm_move()
 {
     ...
     document.form_cancel.action = "news_editorial_list_categ_cons_new.php"; 
 ...
 {
   document.F1.reset();
   document.F1.categoria_nome_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_categoria_nome'), document.F1.categoria_nome_cond, 'categoria_nome');
   document.F1.categoria_nome.value = "";
   document.F1.categoris_descricao_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_categoris_descricao'), document.F1.categoris_descricao_cond, 'categoris_descricao');
   document.F1.categoris_descricao.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $categoria_nome_cond, $categoria_nome,
             $categoris_descricao_cond, $categoris_descricao, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $categoria_nome_cond_salva = $categoria_nome_cond; 
      if (!isset($categoria_nome_input_2) || $categoria_nome_input_2 == "")
      {
          $categoria_nome_input_2 = $categoria_nome;
      }
      $categoris_descricao_cond_salva = $categoris_descricao_cond; 
      if (!isset($categoris_descricao_input_2) || $categoris_descricao_input_2 == "")
      {
          $categoris_descricao_input_2 = $categoris_descricao;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca']['categoria_nome'] = $categoria_nome; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca']['categoria_nome_cond'] = $categoria_nome_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca']['categoris_descricao'] = $categoris_descricao; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca']['categoris_descricao_cond'] = $categoris_descricao_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['categoria_nome'] = $Conteudo;
      $Conteudo = $categoris_descricao;
      $this->cmp_formatado['categoris_descricao'] = $Conteudo;

      //----- $categoria_nome
      $this->Date_part = false;
      if (isset($categoria_nome) || $categoria_nome_cond == "nu" || $categoria_nome_cond == "nn" || $categoria_nome_cond == "ep" || $categoria_nome_cond == "ne")
      {
         $this->monta_condicao("categoria_nome", $categoria_nome_cond, $categoria_nome, "", "categoria_nome");
      }

      //----- $categoris_descricao
      $this->Date_part = false;
      if (isset($categoris_descricao) || $categoris_descricao_cond == "nu" || $categoris_descricao_cond == "nn" || $categoris_descricao_cond == "ep" || $categoris_descricao_cond == "ne")
      {
         $this->monta_condicao("categoris_descricao", $categoris_descricao_cond, $categoris_descricao, "", "categoris_descricao");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_editorial_list_categ_cons_new']['where_pesq'];
