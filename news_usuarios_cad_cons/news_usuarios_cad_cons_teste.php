<?php  
  ...
  session_start() ;
  class news_usuarios_cad_cons_form_teste
  {
  function news_usuarios_cad_cons_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">news_usuarios_cad_cons</FONT></B> 
<br> 
<br> 
...
<input type=submit value="news_usuarios_cad_cons"> 
</form> 
...
<?php
  ...
  $frm_teste = new news_usuarios_cad_cons_form_teste();
  $frm_teste->news_usuarios_cad_cons_teste();
?>
