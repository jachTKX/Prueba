...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_usuario_nome_cond" name="usuario_nome_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuario_nome'), this, 'usuario_nome')">
      ...
      <br><span id="id_hide_usuario_nome"  <?php echo $str_hide_usuario_nome?>><INPUT  type="text" id="SC_usuario_nome" name="usuario_nome" value="<?php echo NM_encode_input($usuario_nome) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_usuario_perfil"  <?php echo $str_hide_usuario_perfil?>> 
<?php
