<?php
   include_once('news_usuarios_cad_cons_session.php');
   @ini_set('session.cookie_httponly', 1);
   @ini_set('session.use_only_cookies', 1);
   @ini_set('session.cookie_secure', 0);
   @session_start() ;
   $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_perfil']          = "";
   $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_prod']       = "/scriptcase/prod";
   $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_conf']       = "C:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/conf";
   $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imagens']    = "/scriptcase2_prod/file/img";
   $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp']  = "/scriptcase/tmp";
   $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_cache']      = "C:/Program Files/NetMake/v9-php73/wwwroot/scriptcase/file/cache";
   $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_doc']        = "/inetpub/wwwroot/scriptcase2_prod/file/doc";
   $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao']         = "conn_example";
    ...
    //check prod
    if(empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_prod']))
    {
            /*check prod*/$_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
    }
    //check img
    if(empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imagens']))
    {
            /*check img*/$_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imagens'] = $str_path_apl_url . "_lib/file/img";
    }
    //check tmp
    if(empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp']))
    {
            /*check tmp*/$_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp'] = $str_path_apl_url . "_lib/tmp";
    }
    //check cache
    if(empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_cache']))
    {
            /*check tmp*/$_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_cache'] = $str_path_apl_dir . "_lib/file/cache";
    }
    //check doc
    if(empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_doc']))
    {
            /*check doc*/$_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_doc'] = $str_path_apl_dir . "_lib/file/doc";
    }
    //end check publication with the prod
//
class news_usuarios_cad_cons_ini
{
   var $nm_cod_apl;
   var $nm_nome_apl;
   var $nm_seguranca;
   ...
   var $Gd_missing;
   var $sc_site_ssl;
   var $link_news_usuarios_cad_frm_edit;
   var $nm_cont_lin;
   var $nm_limite_lin;
...
//
   function init($Tp_init = "")
   {
      ...
      $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['decimal_db'] = "."; 
      $this->nm_cod_apl      = "news_usuarios_cad_cons"; 
      $this->nm_nome_apl     = "Application manage users"; 
      $this->nm_seguranca    = ""; 
      $this->nm_grupo        = "news"; 
...
// 
      ...
      $this->sc_protocolo    = "";
      $this->path_prod       = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_prod'];
      $this->path_conf       = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_conf'];
      $this->path_imagens    = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imagens'];
      $this->path_imag_temp  = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp'];
      $this->path_cache  = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_cache'];
      $this->path_doc        = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_doc'];
      ...
      if (!isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['save_session']['save_grid_state_session']))
      { 
          $_SESSION['scriptcase']['news_usuarios_cad_cons']['save_session']['save_grid_state_session'] = false;
          $_SESSION['scriptcase']['news_usuarios_cad_cons']['save_session']['data'] = '';
      } 
      ...
      $this->path_aplicacao  = substr($this->path_aplicacao, 0, strrpos($this->path_aplicacao, '/')) . '/news_usuarios_cad_cons';
      ...
      $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['path_grid_sv'] = $this->root . substr($this->path_prod, 0, $pos_path) . "/conf/grid_sv/";
      ...
      if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['lang'])) {
          $this->str_lang = $_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['lang'];
      }
      elseif (!isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['actual_lang']) || $_SESSION['scriptcase']['news_usuarios_cad_cons']['actual_lang'] != $this->str_lang) {
          $_SESSION['scriptcase']['news_usuarios_cad_cons']['actual_lang'] = $this->str_lang;
      ...
      {
          include_once("news_usuarios_cad_cons_json.php");
      }
      $this->SC_Link_View = (isset($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_Link_View'])) ? $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_Link_View'] : false;
      if (isset($_GET['SC_Link_View']) && !empty($_GET['SC_Link_View']) && is_numeric($_GET['SC_Link_View']))
      {
          if ($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['embutida'])
          {
              $this->SC_Link_View = true;
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_Link_View'] = true;
          }
      }
    ...
    $out1_img_cache = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp'] . $file_name;
    $orig_img = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp']. '/'.basename($_POST['AjaxCheckImg']);
    ...
    if(file_exists($out1_img_cache)){
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['ancor_save'] = $_POST['ancor_save'];
...
<?php
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['under_dashboard']))
      {
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['under_dashboard'] = false;
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['dashboard_app']   = '';
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['own_widget']      = '';
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['parent_widget']   = '';
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['compact_mode']    = false;
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['remove_margin']   = false;
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['remove_border']   = false;
      }
      if (isset($_GET['under_dashboard']) && 1 == $_GET['under_dashboard'])
      {
          if (isset($_GET['own_widget']) && 'dbifrm_widget' == substr($_GET['own_widget'], 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['own_widget'] = $_GET['own_widget'];
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['under_dashboard'] = true;
              if (isset($_GET['dashboard_app'])) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['dashboard_app'] = $_GET['dashboard_app'];
              }
              if (isset($_GET['parent_widget'])) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['parent_widget'] = $_GET['parent_widget'];
              }
              if (isset($_GET['compact_mode'])) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['compact_mode'] = 1 == $_GET['compact_mode'];
              }
              if (isset($_GET['remove_margin'])) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['remove_margin'] = 1 == $_GET['remove_margin'];
              }
              if (isset($_GET['remove_border'])) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['remove_border'] = 1 == $_GET['remove_border'];
              }
          }
      }
      elseif (isset($under_dashboard) && 1 == $under_dashboard)
      {
          if (isset($own_widget) && 'dbifrm_widget' == substr($own_widget, 0, 13)) {
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['own_widget'] = $own_widget;
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['under_dashboard'] = true;
              if (isset($dashboard_app)) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['dashboard_app'] = $dashboard_app;
              }
              if (isset($parent_widget)) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['parent_widget'] = $parent_widget;
              }
              if (isset($compact_mode)) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['compact_mode'] = 1 == $compact_mode;
              }
              if (isset($remove_margin)) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['remove_margin'] = 1 == $remove_margin;
              }
              if (isset($remove_border)) {
                  $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['remove_border'] = 1 == $remove_border;
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['maximized'] = false;
      }
      if (isset($_GET['maximized']))
      {
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['maximized'] = 1 == $_GET['maximized'];
      }
      $Tmp_apl_lig = "news_usuarios_cad_frm";
      if (is_file($this->root . $this->path_link . "_lib/friendly_url/news_usuarios_cad_frm_ini.txt"))
      {
          $Friendly = file($this->root . $this->path_link . "_lib/friendly_url/news_usuarios_cad_frm_ini.txt");
          if (isset($Friendly[0]) && !empty($Friendly[0]))
          {
              $Tmp_apl_lig = trim($Friendly[0]);
          }
      }
      if (is_file($this->root . $this->path_link . $Tmp_apl_lig . "/news_usuarios_cad_frm_ini.txt"))
      {
          $L_md5 = file($this->root . $this->path_link . $Tmp_apl_lig . "/news_usuarios_cad_frm_ini.txt");
          if (isset($L_md5[6]) && trim($L_md5[6]) == "LigMd5")
          {
              $this->sc_lig_md5["news_usuarios_cad_frm"] = 'S';
          }
      }
      $this->sc_lig_target["C_@scinf_usuario_login"] = '_self';
      $this->sc_lig_target["C_@scinf_usuario_login_@scinf_news_usuarios_cad_frm"] = '_self';
      if ($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['under_dashboard'])
      {
          $sTmpDashboardApp = $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['dashboard_info']['dashboard_app'];
          if ('' != $sTmpDashboardApp && isset($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["news_usuarios_cad_cons"]))
          {
              foreach ($_SESSION['scriptcase']['dashboard_targets'][$sTmpDashboardApp]["news_usuarios_cad_cons"] as $sTmpTargetLink => $sTmpTargetWidget)
              {
      ...
      $this->link_news_usuarios_cad_frm_edit =  $this->sc_protocolo . $this->server . $this->path_link . "" . SC_dir_app_name('news_usuarios_cad_frm') . "/news_usuarios_cad_frm.php" ; 
      if ($Tp_init == "Path_sub")
      {
          return;
      }
      ...
      if (!is_file($this->root . $str_path . 'devel/class/xmlparser/nmXmlparserIniSys.class.php'))
      {
          ...
          unset($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao']);
      }
      ...
      if (isset($_SESSION['sc_session']['SC_parm_violation']) && !isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir']))
      {
      ...
      $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['path_doc'] = $this->path_doc; 
      ...
      if (!is_dir($this->root . $this->path_prod))
      {
          ...
          echo " </tr>";
          echo "</table>";
          if (!$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['iframe_menu'] && (!isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['sc_outra_jan']) || !$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['sc_outra_jan'])) 
          { 
...
// 
      include_once($this->path_aplicacao . "news_usuarios_cad_cons_erro.class.php"); 
      $this->Erro = new news_usuarios_cad_cons_erro();
      include_once($this->path_adodb . "/adodb.inc.php"); 
      $this->sc_Include($this->path_libs . "/nm_sec_prod.php", "F", "nm_reg_prod") ; 
      $this->sc_Include($this->path_libs . "/nm_ini_perfil.php", "F", "perfil_lib") ; 
// 
 if(function_exists('set_php_timezone')) set_php_timezone('news_usuarios_cad_cons'); 
// 
      ...
      if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir'])) {
          ...
          if ($_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "  </HEAD>\r\n";
              $SS_cod_html .= "   <body>\r\n";
          }
          else {
              ...
              $SS_cod_html .= "           <input type=\"button\" name=\"sc_sai_seg\" value=\"OK\" onclick=\"sc_session_redir('" . $_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir'] . "');\">\r\n";
              $SS_cod_html .= "     </form>\r\n";
          ...
          if ($_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir_tp'] == "R") {
              $SS_cod_html .= "      sc_session_redir('" . $_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir'] . "');\r\n";
          }
          ...
          $SS_cod_html .= " </body>\r\n";
          $SS_cod_html .= "</HTML>\r\n";
          unset($_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']);
          unset($_SESSION['sc_session']);
      }
      ...
      $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['seq_dir'] = 0; 
      $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['sub_dir'] = array(); 
      $_SESSION['scriptcase']['nm_bases_security']  = "enc_nm_enc_";
      $this->prep_conect();
      $this->conectDB();
   ...
   function prep_conect()
   {
      if (isset($_SESSION['scriptcase']['sc_connection']) && !empty($_SESSION['scriptcase']['sc_connection']))
      {
          ...
          {
              if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao']) && $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_perfil']) && $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_perfil'] == $NM_con_orig)
              {
/*NM*/            $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_perfil'] = $NM_con_dest;
              }
              if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_con_' . $NM_con_orig]))
              {
                  $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_con_' . $NM_con_orig] = $NM_con_dest;
              }
          }
      }
      $con_devel             = (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao'])) ? $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao'] : ""; 
      $perfil_trab           = ""; 
      $this->nm_falta_var    = ""; 
      $this->nm_falta_var_db = ""; 
      $nm_crit_perfil        = false;
      if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao']))
      {
      ...
      if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_perfil']) && !empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_perfil']))
      {
          $perfil_trab = $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_perfil'];
      }
      ...
      if (!isset($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['embutida_init']) || !$_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['embutida_init']) 
      {
      }
// 
      ...
      {
          $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['decimal_db'] = $_SESSION['scriptcase']['glo_decimal_db']; 
      }
      if (isset($_SESSION['scriptcase']['glo_date_separator']) && !empty($_SESSION['scriptcase']['glo_date_separator']))
      {
          ...
          if (strlen($SC_temp) == 2)
          {
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date']  = substr($SC_temp, 0, 1); 
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date1'] = substr($SC_temp, 1, 1); 
          }
          else
           {
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date']  = $SC_temp; 
              $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date1'] = $SC_temp; 
          }
          $this->date_delim  = $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date'];
          $this->date_delim1 = $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date1'];
      }
// 
...
<?php
   ...
   function conectDB()
   {
      ...
      if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao']))
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_conexao'], $this->root . $this->path_prod, 'news', 1, $this->force_db_utf8); 
      } 
      else 
      { 
          ob_start();
...
// 
   ...
   function sc_Sql_Protect($var, $tp, $conex="")
   {
       ...
       if ($tp == "date")
       {
           ...
           if (isset($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date']))
           {
               $delim  = $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date'];
               $delim1 = $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_sep_date1'];
           }
   ...
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_Gb_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_Gb_date_format'][$GB][$cmp] : "";
   }

   function Get_Gb_prefix_date_format($GB, $cmp)
   {
       return (isset($_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_Gb_prefix_date_format'][$GB][$cmp])) ? $_SESSION['sc_session'][$this->sc_page]['news_usuarios_cad_cons']['SC_Gb_prefix_date_format'][$GB][$cmp] : "";
   }
...
//===============================================================================
//
class news_usuarios_cad_cons_sub_css
{
   function __construct()
   {
      ...
      if ($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['SC_herda_css'] == "N")
      {
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css']['news_usuarios_cad_cons']    = $str_schema_all . "_grid.css";
          $_SESSION['sc_session'][$script_case_init]['SC_sub_css_bw']['news_usuarios_cad_cons'] = $str_schema_all . "_grid_bw.css";
      }
   }
}
//
class news_usuarios_cad_cons_apl
{
   var $Ini;
   var $Erro;
   var $Db;
...
//----- 
   function controle($linhas = 0)
   {
      ...
      if (isset($_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['news_usuarios_cad_cons']))
      { 
          $GLOBALS['nmgp_parms'] = $_SESSION['sc_session']['scriptcase']['embutida_form_pdf']['news_usuarios_cad_cons'];
          $Parms_form_pdf = true;
      } 
      if ($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida'] || $Parms_form_pdf)
      { 
          ...
          { 
              ...
              foreach ($todo as $param)
              {
                   ...
                   if (1 < sizeof($cadapar))
                   {
                       ...
                       nm_limpa_str_news_usuarios_cad_cons($cadapar[1]);
                       nm_protect_num_news_usuarios_cad_cons($cadapar[0], $cadapar[1]);
                       if ($cadapar[1] == "@ ") {$cadapar[1] = trim($cadapar[1]); }
                       $Tmp_par   = $cadapar[0];
                       $$Tmp_par = $cadapar[1];
                       if ($Tmp_par == "nmgp_opcao")
                       {
                           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opcao'] = $cadapar[1];
                       }
                   }
              }
          } 
      ...
      if ($Parms_form_pdf)
      { 
          $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_pdf'] = true;
          $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form'] = true;
          $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_full'] = false;
          $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_pai'] = "";
      } 
      ...
      if (!$this->Ini || isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_ibase'])) 
      { 
          $this->Ini = new news_usuarios_cad_cons_ini(); 
          $this->Ini->init();
      } 
      if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase) && $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_ibase'] = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['emb_lig_aba'] = array();
      $this->Change_Menu = false;
      if ($nmgp_opcao != "ajax_navigate" && $nmgp_opcao != "ajax_detalhe" && isset($_SESSION['scriptcase']['menu_atual']) && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['sc_outra_jan'] || $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['sc_modal']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['news_usuarios_cad_cons']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['news_usuarios_cad_cons'];
          }
          ...
          if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'] && $this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['news_usuarios_cad_cons']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['news_usuarios_cad_cons']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('news_usuarios_cad_cons') . "/news_usuarios_cad_cons.php";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['news_usuarios_cad_cons']['label'] = "" . $this->Ini->Nm_lang['lang_header_usuarios_cad_cons'] . "";
      ...
      $this->Db = $this->Ini->Db; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['nm_tpbanco'] = $this->Ini->nm_tpbanco;
      $this->nm_data = new nm_data("en_us");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      { 
          include_once($this->Ini->path_embutida . "news_usuarios_cad_cons/news_usuarios_cad_cons_erro.class.php"); 
      } 
      else 
      { 
          include_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_erro.class.php"); 
      } 
      $this->Erro      = new news_usuarios_cad_cons_erro();
      $this->Erro->Ini = $this->Ini;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      { 
          require_once($this->Ini->path_embutida . "news_usuarios_cad_cons/news_usuarios_cad_cons_lookup.class.php"); 
      } 
      else 
      { 
          require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_lookup.class.php"); 
      } 
      $this->Lookup       = new news_usuarios_cad_cons_lookup();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      {
          ...
          if (isset($_POST['nmgp_opcao']) && $_POST['nmgp_opcao'] == "ajax_export")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = $nmgp_opcao;
              if ($nmgp_opcao == "print" || $nmgp_opcao == "res_print" || $nmgp_opcao == "det_print")
              {
                  $ajax_opc_print   = true;
                  $nm_arquivo_print = "/sc_news_usuarios_cad_cons_" . session_id();
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['ajax_nav'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['scroll_navigate'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['scroll_navigate_reload'] = false;
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['scroll_navigate_app'] = false;
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['scroll_navigate_header_row']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['scroll_navigate_header_row'] = 1;
          }
          if (isset($_POST['nmgp_opcao']) && ($_POST['nmgp_opcao'] == "ajax_navigate" || $_POST['nmgp_opcao'] == "ajax_detalhe"))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['ajax_nav'] = true;
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['save_grid'] = true;
              }
              ...
              {
                  $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['contr_total_geral'] = "NAO";
                  $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['contr_array_resumo'] = "NAO";
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['tot_geral']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['arr_total']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_group_by']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_x_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_y_axys']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_fill']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_order']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_order_col']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_order_level']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_order_sort']);
                  unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['pivot_tabular']);
              }
          }
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Gb_date_format'])) 
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Gb_date_format'] = array();
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_All_Groupby'] = array('groupby_1' => 'all');
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Groupby_hide'])) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Groupby_hide'] = array();
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Ind_Groupby'])) 
      { 
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_All_Groupby'] as $Ind => $Tp)
          {
              if (!in_array($Ind, $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Groupby_hide'])) 
              { 
                  break;
              }
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Ind_Groupby'] = $Ind;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['Labels_GB'] = array();
      if  ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Ind_Groupby'] == "groupby_1")
      {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['Labels_GB'][] = "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_perfil'] . "";
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['all']['SC_Ind_Groupby'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Ind_Groupby']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['all']['SC_Ind_Groupby'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Ind_Groupby'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Gb_Free_cmp']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['all']['SC_Gb_Free_cmp'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Gb_Free_cmp'];
          }
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['res']['summarizing_fields_display'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['res']['summarizing_fields_order']   = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['res']['summarizing_fields_control'] = array();
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['res']['pivot_x_axys']               = array();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['res']['summarizing_fields_display'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_order']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['res']['summarizing_fields_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_order'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_control']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['res']['summarizing_fields_control'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_control'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_x_axys']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dados_orig_gb']['res']['pivot_x_axys'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_x_axys'];
          }
      }
      $this->Ini->Apl_resumo  = "news_usuarios_cad_cons_resumo_" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Ind_Groupby'] . ".class.php"; 
      $this->Ini->Apl_grafico = "news_usuarios_cad_cons_grafico_" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Ind_Groupby'] . ".class.php"; 
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['xls_return']  = ($nmgp_opcao == "xls")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['csv_return']  = ($nmgp_opcao == "csv")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['xml_return']  = ($nmgp_opcao == "xml")  ? "volta_grid" : "resumo"; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['json_return'] = ($nmgp_opcao == "json") ? "volta_grid" : "resumo"; 
      ...
      if ($nmgp_opcao == 'print' || $nmgp_opcao == 'res_print') {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_return'] = $this->ret_print;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      {
          if ($this->Ini->Export_html_zip)
          {
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['html_name']))
              {
                  $nm_arquivo_html = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['html_name'];
              }
              elseif ($nmgp_opcao == 'print' && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
              {
                  $nm_arquivo_html = "/sc_news_usuarios_cad_cons_" . session_id() . ".html";
              }
              else
              {
                  $nm_arquivo_html = "/sc_news_usuarios_cad_cons_res_" . session_id() . ".html";
              }
      ...
      if ($nmgp_opcao == "doc_word") {  
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_return'] = $this->ret_word;
          $_SESSION['scriptcase']['proc_mobile'] = false;
      }
      ...
      { 
          $nmgp_opcao = "doc_word"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "doc_word"; 
      }
      elseif ($nmgp_opcao == "doc_word" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "doc_word_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "doc_word_res"; 
      }
      if ($nmgp_opcao == "xls_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xls"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "xls"; 
      }
      elseif ($nmgp_opcao == "xls" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xls_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "xls_res"; 
      }
      if ($nmgp_opcao == "csv_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "csv"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "csv"; 
      }
      elseif ($nmgp_opcao == "csv" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "csv_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "csv_res"; 
      }
      if ($nmgp_opcao == "xml_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "xml"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "xml"; 
      }
      elseif ($nmgp_opcao == "xml" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "xml_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "xml_res"; 
      }
      if ($nmgp_opcao == "json_res" && strpos(" " . $this->Ini->SC_module_export, "grid") !== false)  
      { 
          $nmgp_opcao = "json"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "json"; 
      }
      elseif ($nmgp_opcao == "json" && strpos(" " . $this->Ini->SC_module_export, "grid") === false)  
      { 
          $nmgp_opcao = "json_res"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "json_res"; 
      }
      $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['skip_charts'] = (strpos(" " . $this->Ini->SC_module_export, "chart") !== false) ? false : true;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_det'] = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['conf_chart_level'] = "S";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida']      = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_grid']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_grid'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_init']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_init'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_label']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_label'] = false;
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cab_embutida']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cab_embutida'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_pdf']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_pdf'] = "";
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_treeview']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida_treeview'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['proc_pdf'] = (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'] && ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "pdf" || $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "pdf_res")) ? true : false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['proc_pdf']) {
          $_SESSION['scriptcase']['proc_mobile'] = false;
      } 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['proc_pdf_vert'] = false;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['field_order']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['field_order'][] = "usuario_login";
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['field_order'][] = "usuario_nome";
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['field_order'][] = "usuario_email";
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['field_order_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['field_order'];
          if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['usr_cmp_sel']))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['usr_cmp_sel'] = array();
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['usr_cmp_sel_orig'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['usr_cmp_sel'];
      } 
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['news_usuarios_cad_cons']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['news_usuarios_cad_cons']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['news_usuarios_cad_cons']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }

      $this->Ini->sc_Include($this->Ini->path_libs . "/nm_gc.php", "F", "nm_gc") ; 
      nm_gc($this->Ini->path_libs);
      if (!$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida'])
      { 
      ...
      if (!$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida'])
      { 
          $this->pdf_zip = (isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opc_pdf']['pdf_zip'])) ? $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opc_pdf']['pdf_zip'] : "N";
          $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['use_pass_pdf'] = "";
      ...
      if ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_orig'])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "inicio";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['news_usuarios_cad_cons']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['news_usuarios_cad_cons']['start'] == 'filter')
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "inicio" || $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "grid")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "busca";
          }   
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opc_liga'] = array();  
          if (isset($NMSC_conf_apl) && !empty($NMSC_conf_apl))
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opc_liga'] = $NMSC_conf_apl;  
          }   
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opc_liga']['inicial']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opc_liga']['inicial'];
          }
      }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opc_liga']['paginacao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opc_liga']['paginacao']))
          { 
              $this->Ini->Apl_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opc_liga']['paginacao'];
          } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'] && $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "busca")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "grid" ;  
      }   
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao_print']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao_print']))  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao_print'] = "inicio" ;  
      }   
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_all'] = false;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "print")  
      { 
          if (strpos(" " . $this->Ini->SC_module_export, "grid") === false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "res_print";
          }
      } 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "res_print")  
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao']     = "resumo";
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_all'] = true;
          if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "print";
              $nmgp_tipo_print = "RC";
          }
      } 
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'], 0, 7) == "grafico")  
      { 
          $_SESSION['scriptcase']['sc_ctl_ajax'] = 'part';
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == 'pesq' && isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['orig_pesq']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['orig_pesq']))  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['orig_pesq'] == "res")  
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = 'resumo';
          } 
          elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['orig_pesq'] == "grid") 
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = 'inicio';
          } 
      } 
//
      ...
      if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "detalhe" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_orig']) || !empty($nmgp_parms) || !empty($GLOBALS["nmgp_parms"])))  
      { 
         unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['use_pass_pdf']);
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['prim_cons'] = true;  
      ...
      $nm_flag_pdf   = true;
      $nm_vendo_pdf  = ("pdf" == $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao']);
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['graf_pdf'] = "S";
      if (isset($nmgp_graf_pdf) && !empty($nmgp_graf_pdf))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['graf_pdf'] = $nmgp_graf_pdf;
      }
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      {
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            $nm_arquivo_htm_temp = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_news_usuarios_cad_cons_html_" . session_id() . "_2.html";
            $nm_arquivo_pdf_base = "/sc_pdf_" . md5(date("Ymd") . "_" . session_id()) . "_news_usuarios_cad_cons.pdf";
            $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . $nm_arquivo_pdf_base;
            $nm_arquivo_pdf_serv = $this->Ini->root . $nm_arquivo_pdf_url;
            $nm_arquivo_de_saida = $this->Ini->root . $this->Ini->path_imag_temp . "/sc_news_usuarios_cad_cons_html_" . session_id() . ".html";
            $nm_url_de_saida = $this->Ini->server_pdf . $this->Ini->path_imag_temp . "/sc_news_usuarios_cad_cons_html_" . session_id() . ".html";
...
//----------------------------------->
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "doc_word_res")
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_navigator'] = "Microsoft Internet Explorer";
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_all'] = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['doc_word']  = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao']     = "resumo";
          $_SESSION['scriptcase']['saida_word'] = true;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_name']))
          {
              $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_name'], ".");
              if ($Pos === false) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_name'] .= ".doc";
              }
              $nm_arquivo_doc_word = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_name'];
          }
          else
          {
              $nm_arquivo_doc_word = "/sc_news_usuarios_cad_cons_res_" . session_id() . ".doc";
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "xls")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "news_usuarios_cad_cons/news_usuarios_cad_cons_xls.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_xls.class.php"); 
          } 
          $this->xls  = new news_usuarios_cad_cons_xls();
          $this->prep_modulos("xls");
          $this->xls->monta_xls();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "xml")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "news_usuarios_cad_cons/news_usuarios_cad_cons_xml.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_xml.class.php"); 
          } 
          $this->xml  = new news_usuarios_cad_cons_xml();
          $this->prep_modulos("xml");
          $this->xml->monta_xml();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "json")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "news_usuarios_cad_cons/news_usuarios_cad_cons_json.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_json.class.php"); 
          } 
          $this->json  = new news_usuarios_cad_cons_json();
          $this->prep_modulos("json");
          $this->json->monta_json();
      }
      else
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "csv")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "news_usuarios_cad_cons/news_usuarios_cad_cons_csv.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_csv.class.php"); 
          } 
          $this->csv  = new news_usuarios_cad_cons_csv();
          $this->prep_modulos("csv");
          $this->csv->monta_csv();
      }
      else   
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "rtf")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "news_usuarios_cad_cons/news_usuarios_cad_cons_rtf.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_rtf.class.php"); 
          } 
          $this->rtf  = new news_usuarios_cad_cons_rtf();
      ...
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
          { 
              require_once($this->Ini->path_embutida . " . news_usuarios_cad_cons . /" . $this->Ini->Apl_grafico); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_grafico); 
          } 
          $this->Graf  = new news_usuarios_cad_cons_grafico();
          $this->prep_modulos("Graf");
          if (substr($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'], 7, 1) == "_")  
          { 
              $this->Graf->grafico_col(substr($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'], 8));
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "grid";
          }
          else
          { 
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dashboard_refresh_after_chart'])) {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dashboard_refresh_after_chart'];
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dashboard_refresh_after_chart']);
              }
              else {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] = "grid";
              }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "busca")  
      { 
          if (!$_SESSION['scriptcase']['proc_mobile']) 
          { 
              require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_pesq.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_mobile_pesq.class.php"); 
          } 
          $this->pesq  = new news_usuarios_cad_cons_pesq();
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "resumo")  
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "news_usuarios_cad_cons/" . $this->Ini->Apl_resumo); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . $this->Ini->Apl_resumo); 
          } 
          $this->Res = new news_usuarios_cad_cons_resumo("out");
          $this->prep_modulos("Res");
          $this->Res->monta_resumo();
      }
      else 
      { 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "print" && $nmgp_tipo_print == "RC")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_navigator'] = $nmgp_navegator_print;
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao']     = "pdf";
              $GLOBALS['nmgp_tipo_pdf'] = strtolower($nmgp_cor_print);
          } 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "doc_word")
          { 
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_navigator'] = "Microsoft Internet Explorer";
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_all'] = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['doc_word']  = true;
              ...
              {
                  $nm_arquivo_doc_word = "/sc_news_usuarios_cad_cons_" . session_id() . ".doc";
              }
              $nm_saida->seta_arquivo($this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word);
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
          { 
              require_once($this->Ini->path_embutida . "news_usuarios_cad_cons/news_usuarios_cad_cons_grid.class.php"); 
          } 
          else 
          { 
              require_once($this->Ini->path_aplicacao . "news_usuarios_cad_cons_grid.class.php"); 
          } 
          $this->grid  = new news_usuarios_cad_cons_grid();
...
<?php
      ...
      if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      {
         ...
         {
             $Temp = ob_get_clean();
             if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "ajax_detalhe")  
             {
                 $this->Ini->Arr_result['setVar'][] = array('var' => 'scQtReg', 'value' => $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['qt_reg_grid']);
             }
             $_SESSION['scriptcase']['saida_var'] = false;
             $oJson = new Services_JSON();
            ...
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_sel_columns']['field_order']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['field_order'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_sel_columns']['field_order'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_sel_columns']['field_order']);
            }
            if(isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_sel_columns']['usr_cmp_sel']))
            {
                $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['usr_cmp_sel'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_sel_columns']['usr_cmp_sel'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_sel_columns']['usr_cmp_sel']);
            }
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['doc_word'])
         {
             $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file'] = $this->Ini->root . $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
         ...
         if ($nm_flag_pdf && $nm_vendo_pdf)
         {
            ...
            if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_res'])
            { 
                $str_pd4ml .= " --outline-depth 0";
            }
            if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name']))
            {
                $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name'], ".");
                if ($Pos === false) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name'] .= ".pdf";
                }
                if ('/' == substr($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name'], 0, 1)) {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name'] = substr($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name'], 1);
                }
                $nm_arquivo_pdf_serv = $this->Ini->root .  $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name'];
                $nm_arquivo_pdf_url  = $this->Ini->path_imag_temp . "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name'];
                $nm_arquivo_pdf_base = "/" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name'];
                unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_name']);
            }
            ...
            elseif (is_dir($this->Ini->path_third . $dir_qpdf) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['use_pass_pdf']))
            {
            ...
            if ($this->pdf_zip == "S")
            {
                $pdf_pass = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['use_pass_pdf'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['use_pass_pdf'] : "";
            ...
            elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['use_pass_pdf']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['use_pass_pdf']))
            {
                if (FALSE !== strpos(strtolower(php_uname()), 'windows')) 
                {
                    $dir_qpdf = "/qpdf/win/bin";
                ...
                if (is_dir($this->Ini->path_third . $dir_qpdf)) 
                {
                    ...
                    $pdf_pass  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['use_pass_pdf'];
            ...
            $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['contr_array_resumo'] = '';
            $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['contr_total_geral']  = '';
            // ----- PDF log
...
unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_file']);
if (is_file($nm_arquivo_pdf_serv))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pdf_file'] = $nm_arquivo_pdf_serv;
}
?>
...
$_SESSION['scriptcase']['news_usuarios_cad_cons']['contr_erro'] = 'off';
  ...
  function html_doc_word($nm_arquivo_doc_word, $nmgp_password)
  {
      ...
      { 
          ...
          $Arq_zip = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file'];
          $Pos = strrpos($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file'], ".");
          if ($Pos !== false) {
              $Arq_zip = substr($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file'], 0, $Pos);
          }
          $Arq_zip .= ".zip";
          ...
          $Arq_input = (FALSE !== strpos($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file'], ' ')) ? " \"" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file'] . "\"" :  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file'];
           if (is_file($Arq_zip)) {
               unlink($Arq_zip);
           }
           $str_zip = "";
           ...
           if (is_file($Arq_zip)) {
               unlink($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file']);
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file'] = $Arq_zip;
               $nm_arquivo_doc_word = $Arq_doc;
          } 
      } 
      if ($this->Ini->sc_export_ajax)
      {
          $this->Arr_result['file_export']  = NM_charset_to_utf8($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['word_file']);
      ...
      if (strpos(" " . $this->Ini->SC_module_export, "grid") !== false)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_doc_word;
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons'][$path_doc_md5][1] = substr($nm_arquivo_doc_word, 1);
...
<HTML<?php echo $_SESSION['scriptcase']['reg_conf']['html_dir'] ?>>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_header_usuarios_cad_cons'] ?> :: Doc</TITLE>
 <META http-equiv="Content-Type" content="text/html; charset=<?php echo $_SESSION['scriptcase']['charset_html'] ?>" />
<?php
if ($_SESSION['scriptcase']['proc_mobile'])
{
...
<form name="Fdown" method="get" action="news_usuarios_cad_cons_download.php" target="_blank" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="news_usuarios_cad_cons"> 
<input type="hidden" name="nm_name_doc" value="<?php echo $path_doc_md5 ?>"> 
</form>
<FORM name="F0" method=post action="news_usuarios_cad_cons.php"> 
<INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      ...
      $Html_password = "";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons'][$path_doc_md5][0] = $this->Ini->path_imag_temp . $nm_arquivo_html;
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons'][$path_doc_md5][1] = substr($nm_arquivo_html, 1);
          require_once($this->Ini->path_lib_php . "/sc_progress_bar.php");
          $this->pb = new scProgressBar();
          $this->pb->setRoot($this->Ini->root);
          $this->pb->setDir($_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp'] . "/");
...
// 
//======= =========================
   if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['sc_process_barr'])) {
       return;
   }
   ...
   if (!empty($_POST))
   {
       ...
       foreach ($_POST as $nmgp_var => $nmgp_val)
       {
            ...
            nm_limpa_str_news_usuarios_cad_cons($nmgp_val);
            $nmgp_val = NM_decode_input($nmgp_val);
            nm_protect_num_news_usuarios_cad_cons($nmgp_var, $nmgp_val);
            $$nmgp_var = $nmgp_val;
       }
   }
   if (!empty($_GET))
   ...
   if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
       ...
       elseif (is_file($root . $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp'] . "/sc_apl_default_news.txt")) {
           $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp'] . "/sc_apl_default_news.txt"));
       }
       if (isset($apl_def)) {
           if ($apl_def[0] != "news_usuarios_cad_cons") {
               $_SESSION['scriptcase']['sem_session'] = true;
               if (strtolower(substr($apl_def[0], 0 , 7)) == "http://" || strtolower(substr($apl_def[0], 0 , 8)) == "https://" || substr($apl_def[0], 0 , 2) == "..") {
                   $_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir'] = $apl_def[0];
               }
               else {
                   $_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir'] = $path_aplicacao . "/" . SC_dir_app_name($apl_def[0]) . "/index.php";
               }
               $Redir_tp = (isset($apl_def[1])) ? trim(strtoupper($apl_def[1])) : "";
               $_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir_tp'] = $Redir_tp;
           }
           if (isset($_COOKIE['sc_actual_lang_news'])) {
               $_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_news'];
           }
       }
   }
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_pai']))
   {
       $apl_pai = $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_pai'];
       if (isset($_SESSION['sc_session'][$script_case_init][$apl_pai]['embutida_filho']))
       {
           ...
           {
               if (isset($_SESSION['sc_session'][$init_filho]['news_usuarios_cad_cons']['master_pai']) && $_SESSION['sc_session'][$init_filho]['news_usuarios_cad_cons']['master_pai'] == $script_case_init)
               {
   ...
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form'] && !isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['master_pai']))
   {
       $SC_init_ant = $script_case_init;
       $script_case_init = rand(2, 10000);
       if (isset($_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_pai']))
       {
           $_SESSION['sc_session'][$SC_init_ant][$_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_pai']]['embutida_filho'][] = $script_case_init;
       }
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['master_pai'] = $SC_init_ant;
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['master_pai']))
   {
       $SC_init_ant = $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['master_pai'];
       if (!isset($_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_form_parms']))
       {
           $_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_form_parms'] = "";
       }
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_parms'] = $_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_form_parms'];
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form'] = true;
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_full'] = (isset($_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_form_full'])) ? $_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_form_full'] : false;
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['reg_start'] = "";
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opcao'] = "inicio";
       unset($_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_form']);
       unset($_SESSION['sc_session'][$SC_init_ant]['news_usuarios_cad_cons']['embutida_form_parms']);
   }
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_parms'])) 
   {
       if (!empty($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_parms'])) 
       {
           $nmgp_parms = $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_parms'];
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_parms'] = "";
       }
   }
   elseif (isset($script_case_init))
   {
       unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form']);
       unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_full']);
       unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_parms']);
   }
   if (!isset($nmgp_opcao) || !isset($script_case_init) || ((!isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida']) || !$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida']) && $nmgp_opcao != "formphp"))
   { 
       if (!empty($nmgp_parms)) 
       { 
           ...
           { 
               unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']);
               $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['b_sair'] = false;
           }   
       } 
   } 
   $ini_embutida = "";
   if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida']) && $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida'])
   {
       $nmgp_outra_jan = "";
   }
   ...
   if (isset($GLOBALS["script_case_init"]) && !empty($GLOBALS["script_case_init"]))
   {
       $ini_embutida = $GLOBALS["script_case_init"];
        if (!isset($_SESSION['sc_session'][$ini_embutida]['news_usuarios_cad_cons']['embutida']))
        { 
           $_SESSION['sc_session'][$ini_embutida]['news_usuarios_cad_cons']['embutida'] = false;
        }
        if (!$_SESSION['sc_session'][$ini_embutida]['news_usuarios_cad_cons']['embutida'])
        { 
           $script_case_init = $ini_embutida;
        }
   }
   if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['protect_modal']) && !empty($_SESSION['scriptcase']['news_usuarios_cad_cons']['protect_modal']))
   {
       $script_case_init = $_SESSION['scriptcase']['news_usuarios_cad_cons']['protect_modal'];
   }
   ...
   $salva_emb    = false;
   $salva_iframe = false;
   $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['doc_word'] = false;
   $_SESSION['scriptcase']['saida_word'] = false;
   if (!isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['skip_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['skip_charts'] = false;
   }
   if (isset($_REQUEST['sc_create_charts']))
   {
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['skip_charts'] = 'N' == $_REQUEST['sc_create_charts'];
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['iframe_menu']))
   {
       $salva_iframe = $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['iframe_menu'];
       unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['iframe_menu']);
   }
   if (isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida']))
   {
       $salva_emb = $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida'];
       unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida']);
   }
   if (isset($nm_run_menu) && $nm_run_menu == 1 && !$salva_emb)
   {
        ...
        $_SESSION['scriptcase']['sc_apl_menu_atual'] = "news_usuarios_cad_cons";
        $achou = false;
        if (isset($_SESSION['sc_session'][$script_case_init]))
        {
            foreach ($_SESSION['sc_session'][$script_case_init] as $nome_apl => $resto)
            {
                if ($nome_apl == 'news_usuarios_cad_cons' || $achou)
                {
        ...
        $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['iframe_menu'] = true;
   }
   else
   {
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['iframe_menu'] = $salva_iframe;
   }
   $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida'] = $salva_emb;

   if (!isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['initialize']))
   {
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['initialize'] = true;
   }
   elseif (!isset($_SERVER['HTTP_REFERER']))
   {
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['initialize'] = false;
   }
   ...
   else
   {
       ...
       if ('news_usuarios_cad_cons' == $sReferer || 'news_usuarios_cad_cons_' == substr($sReferer, 0, 23))
       {
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['initialize'] = false;
       }
       else
   ...
   if ($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['initialize'])
   {
       unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['tot_geral']);
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['contr_total_geral'] = "NAO";
   }
   ...
   {
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['orig_pesq'] = $nmgp_orig_pesq;
   }
   if (!isset($nmgp_opcao) || empty($nmgp_opcao) || $nmgp_opcao == "grid" && (!isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['b_sair'])))
   {
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['b_sair'] = true;
   }
   $STR_lang    = (isset($_SESSION['scriptcase']['str_lang']) && !empty($_SESSION['scriptcase']['str_lang'])) ? $_SESSION['scriptcase']['str_lang'] : "en_us";
   if (isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['lang'])) {
       $STR_lang = $_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['lang'];
   }
   $STR_schema_all = (isset($_SESSION['scriptcase']['str_schema_all']) && !empty($_SESSION['scriptcase']['str_schema_all'])) ? $_SESSION['scriptcase']['str_schema_all'] : "Sc9_SweetGoldenSand/Sc9_SweetGoldenSand";
   ...
   if (isset($_SESSION['scriptcase']['sc_outra_jan']) && $_SESSION['scriptcase']['sc_outra_jan'] == 'news_usuarios_cad_cons')
   {
       $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['sc_outra_jan'] = true;
        unset($_SESSION['scriptcase']['sc_outra_jan']);
   }
   $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['menu_desenv'] = false;   
   if (!defined("SC_ERROR_HANDLER"))
   {
       define("SC_ERROR_HANDLER", 1);
       include_once(dirname(__FILE__) . "/news_usuarios_cad_cons_erro.php");
   }
   ...
   if (!$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida'] && $nmgp_opcao != "formphp")
   { 
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['sc_change_lang'] = true;
           unset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['tot_geral']);
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['contr_total_geral'] = "NAO";
       ...
       { 
           ...
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['num_css'] = rand(0, 1000);
       } 
       ...
       if (!empty($nmgp_opcao))  
       { 
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opcao'] = $nmgp_opcao ;  
       }   
       if (isset($nmgp_lig_edit_lapis)) 
       {
          $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['mostra_edit'] = $nmgp_lig_edit_lapis;
       ...
       $nm_saida = "";
       if (isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['volta_redirect_apl']) && !empty($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['volta_redirect_apl']))
       {
           $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['volta_redirect_apl']; 
           $nm_apl_dependente = $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['volta_redirect_tp']; 
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['volta_redirect_apl'] = "";
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['volta_redirect_tp'] = "";
           $nm_url_saida = "news_usuarios_cad_cons_fim.php"; 
       
       }
       elseif (substr($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opcao'] != "pdf" ) 
       {
           if (isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['sc_outra_jan']) && $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['sc_outra_jan'])
           {
               if ($nmgp_url_saida == "modal")
               {
                   $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['sc_modal'] = true;
               }
               $nm_url_saida = "news_usuarios_cad_cons_fim.php"; 
           }
           else
           {
               ...
               { 
                   $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['retorno_cons'] = $nmgp_url_saida ; 
               } 
               if (!empty($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['retorno_cons'])) 
               { 
                   $nm_url_saida = $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['retorno_cons']  . "?script_case_init=" . NM_encode_input($script_case_init);  
                   $nm_apl_dependente = 1 ; 
               } 
...
// 
       if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && substr($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opcao'], 0, 7) != "grafico" && $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opcao'] != "pdf" ) 
       { 
            $_SESSION['scriptcase']['sc_url_saida'][$script_case_init] = $_SESSION['scriptcase']['nm_sc_retorno']; 
            $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['menu_desenv'] = true;   
       } 
       if (isset($nmgp_parms_ret)) 
       {
           ...
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['form_psq_ret']  = $todo[0];
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['campo_psq_ret'] = $todo[1];
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['dado_psq_ret']  = $todo[2];
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['js_apos_busca'] = $nm_evt_ret_busca;
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opc_psq'] = true;   
           if (isset($nmgp_iframe_ret)) 
           {
               $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['iframe_ret_cap'] = $nmgp_iframe_ret;
           }
       } 
       elseif (!isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opc_psq']))
       {
           $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opc_psq'] = false ;   
       } 
       if (isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form'])
       {
           if (!isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_full']) || !$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form_full'])
           {
               $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['mostra_edit'] = "N";   
           } 
       ...
       if (!$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opc_psq'] && !isset($_SESSION['scriptcase']['news_usuarios_cad_cons']['session_timeout']['redir'])) 
       { 
          if (!isset($_SESSION['scriptcase']['sc_apl_seg']['news_usuarios_cad_cons']) || $_SESSION['scriptcase']['sc_apl_seg']['news_usuarios_cad_cons'] != "on")
          { 
              $NM_Mens_Erro = $Nm_lang['lang_errm_unth_user'];
              $nm_botao_ok = ($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['iframe_menu']) ? false : true;
              ...
              if ((isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida']) && $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida']) || (isset($_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form']) && $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida_form']))
              {
                   $nm_botao_ok = false;
              }
?>
...
<?php
       ...
       $contr_news_usuarios_cad_cons = new news_usuarios_cad_cons_apl();

      if ('ajax_autocomp' == $nmgp_opcao)
      {
          $nmgp_opcao = 'busca';
          $_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['opcao'] = "busca";
          $contr_news_usuarios_cad_cons->NM_ajax_flag = true;
          $contr_news_usuarios_cad_cons->NM_ajax_opcao = $NM_ajax_opcao;
      }
       $contr_news_usuarios_cad_cons->controle();
   } 
   if (!$_SESSION['sc_session'][$script_case_init]['news_usuarios_cad_cons']['embutida'] && $nmgp_opcao == "formphp")
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 0;  
...
//
   function nm_limpa_str_news_usuarios_cad_cons(&$str)
   {
   ...
   function nm_protect_num_news_usuarios_cad_cons($name, &$val)
   {
       if (empty($val))
       {
          return;
   ...
   function news_usuarios_cad_cons_pack_protect_string($sString)
   {
    ...
    function news_usuarios_cad_cons_pdf_progress_call($message, $Nm_lang, $flushBuffer = false) {
