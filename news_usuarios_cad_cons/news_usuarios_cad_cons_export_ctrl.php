<?php
@session_start() ;
$_SESSION['scriptcase']['news_usuarios_cad_cons']['sc_process_barr'] = true;
require_once('../news_usuarios_cad_cons/index.php');
unset($_SESSION['scriptcase']['news_usuarios_cad_cons']['sc_process_barr']);
$ExportCtrl = new news_usuarios_cad_cons_export_control;
$ExportCtrl->Export_barr();

class news_usuarios_cad_cons_export_control
{
