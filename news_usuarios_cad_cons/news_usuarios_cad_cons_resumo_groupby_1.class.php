...
class news_usuarios_cad_cons_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_usuario_perfil;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_usuario_perfil = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['array_graf_pdf'] = array();
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['contr_total_geral'] == "OK")
      {
          $this->array_total_usuario_perfil = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['arr_total']['usuario_perfil'];
      }
      else
      {
          $this->array_total_usuario_perfil = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['arr_total']['usuario_perfil'] = $this->array_total_usuario_perfil;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['json_use_label'])
       {
          $Lab_usuario_perfil = "usuario_perfil";
       }
       else
       {
       $Lab_usuario_perfil = "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_perfil'] . "";
       }
       $this->comp_field = array(
           $Lab_usuario_perfil,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_login']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_login'] = "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_login'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_nome']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_nome'] = "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_nome'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_email']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_email'] = "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_email'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_senha']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_senha'] = "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_senha'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_perfil']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['usuario_perfil'] = "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_perfil'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['pula_linha_quebra']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['labels']['pula_linha_quebra'] = ""; 
       }
       //-----
       $this->comp_field_nm = array(
           'usuario_perfil' => 0,
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_order']['groupby_1']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_order']['groupby_1'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_order']['groupby_1'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display']['groupby_1'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display']['groupby_1'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display']['groupby_1'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display']['groupby_1'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display']['groupby_1'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display']['groupby_1'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['summarizing_fields_display']['groupby_1'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_usuario_perfil as $i_usuario_perfil => $d_usuario_perfil) {
           if (!in_array($i_usuario_perfil, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_usuario_perfil[2] ] = $d_usuario_perfil[1];
               $this->comp_label[0][ $d_usuario_perfil[2] ] = $d_usuario_perfil[1];
           }
       }
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_usuario_perfil => $l_usuario_perfil) {
           if (isset($this->array_total_usuario_perfil[$i_usuario_perfil])) {
               $this->comp_group[$i_usuario_perfil] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_usuario_perfil;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@news_usuarios_cad_cons@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
                   {
               ...
               $chart   = (($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "print" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "pdf" && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida']) && isset($columns['chart']) && '' != $columns['chart'] && isset($this->comp_chart_data[ $columns['chart'] ]))
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "pdf" && $_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   function resumo_sem_reg()
   {
      ...
      $nm_saida->saida("   <TD class=\"scGridFieldOdd scGridFieldOddFont\" align=\"center\" style=\"vertical-align: top;font-family:Tahoma, Arial, sans-serif;font-size:12px;color:#000000;\">\r\n");
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new news_usuarios_cad_cons_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_usuario_perfil);
   }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "news_usuarios_cad_cons/news_usuarios_cad_cons_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_usuarios_cad_cons_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_news_usuarios_cad_cons_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_usuarios_cad_cons_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['doc_word']) 
      {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'])
      {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "news_usuarios_cad_cons/news_usuarios_cad_cons_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=&nm_all_modules=grid&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
      ...
      if ($this->nmgp_botoes['chart_detail'] == 'on' && !$this->grid_emb_form && !$this->NM_res_sem_reg)
      {
         ...
         if (is_file("news_usuarios_cad_cons_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'news_usuarios_cad_cons_config_pivot.php?nome_apl=news_usuarios_cad_cons&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</script>\r\n");
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"news_usuarios_cad_cons.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"news_usuarios_cad_cons.php\"\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("      else\r\n");
      $nm_saida->saida("      {\r\n");
      $nm_saida->saida("          window.open(\"" . $this->Ini->path_link . "news_usuarios_cad_cons/news_usuarios_cad_cons.php?nmgp_opcao=pdf&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&nmgp_graf_pdf=\" + g + \"&SC_module_export=\" + SC_module_export + \"&use_pass_pdf=\" + use_pass_pdf + \"&pdf_all_cab=\" + pdf_all_cab + \"&pdf_all_label=\" +  pdf_all_label + \"&pdf_label_group=\" +  pdf_label_group + '&pdf_zip=' +  pdf_zip + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "\", \"_blank\");\r\n");
      $nm_saida->saida("      }\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_usuarios_cad_cons_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "news_usuarios_cad_cons/news_usuarios_cad_cons_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $usuario_nome = $Busca_temp['usuario_nome']; 
          $tmp_pos = strpos($usuario_nome, "##@@");
          if ($tmp_pos !== false && !is_array($usuario_nome))
          {
              $usuario_nome = substr($usuario_nome, 0, $tmp_pos);
          }
          $usuario_perfil = $Busca_temp['usuario_perfil']; 
          $tmp_pos = strpos($usuario_perfil, "##@@");
          if ($tmp_pos !== false && !is_array($usuario_perfil))
          {
              $usuario_perfil = substr($usuario_perfil, 0, $tmp_pos);
          }
      } 
     ...
     elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['doc_word'] || $this->Ini->sc_export_ajax_img)
     {
   ...
   //---- 
   function adiciona_registro($quebra_usuario_perfil, $quebra_usuario_perfil_orig)
   {
      //----- usuario_perfil
      if (!isset($this->array_total_usuario_perfil[$quebra_usuario_perfil_orig]))
      {
         $this->array_total_usuario_perfil[$quebra_usuario_perfil_orig][0] = 1;
         $this->array_total_usuario_perfil[$quebra_usuario_perfil_orig][1] = $quebra_usuario_perfil;
         $this->array_total_usuario_perfil[$quebra_usuario_perfil_orig][2] = $quebra_usuario_perfil_orig;
      }
      else
      {
         $this->array_total_usuario_perfil[$quebra_usuario_perfil_orig][0]++;
      }
   }
...
//
   function nm_acumula_resumo($nm_tipo="resumo")
   {
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'usuario_perfil');
     $campos_order = $this->Ini->Get_date_order_groupby("usuario_perfil", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->usuario_login = $rs_res->fields[0] ;  
            $this->usuario_nome = $rs_res->fields[1] ;  
            $this->usuario_email = $rs_res->fields[2] ;  
            $this->usuario_perfil = $rs_res->fields[3] ;  
...
$_SESSION['scriptcase']['news_usuarios_cad_cons']['contr_erro'] = 'off'; 
            $this->usuario_perfil_orig = $this->usuario_perfil;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->usuario_perfil, $this->usuario_perfil_orig);
            }
   }
//
