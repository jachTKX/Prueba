...
class news_usuarios_cad_cons_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "news_usuarios_cad_cons.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_header_usuarios_cad_cons'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>news_usuarios_cad_cons/news_usuarios_cad_cons_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="news_usuarios_cad_cons_ajax_search.js"></script>
 <script type="text/javascript" src="news_usuarios_cad_cons_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="news_usuarios_cad_cons_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['news_usuarios_cad_cons']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="news_usuarios_cad_cons.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<style>
#lin1_col1 { padding-left:9px; padding-top:7px;  height:27px; overflow:hidden; text-align:left; font-size:16px; font-weight:bold;  color: #eccc68;}			 
#lin1_col2 { padding-right:9px; padding-top:7px; height:27px; text-align:right; overflow:hidden; font-size:16px; font-weight:bold; color: #eccc68;}
</style>
...
<div style="width: 100%">
 ...
 <div style="height:37px; background-color:#FFFFFF; border-width:0px 0px 1px 0px;  border-style: dashed; border-color:#ddd; display: block">
 	<table style="width:100%; border-collapse:collapse; padding:0;">
    	<tr>
        	<td id="lin1_col1" class="scFilterHeaderFont"><span><?php echo $this->Ini->Nm_lang['lang_header_usuarios_cad_cons'] ?></span></td>
...
<?php
   ...
   {
      global 
             $usuario_nome_cond, $usuario_nome,
             $usuario_perfil_cond, $usuario_perfil,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!isset($usuario_nome_cond) || empty($usuario_nome_cond))
      {
         $usuario_nome_cond = "eq";
      }
      if (!isset($usuario_perfil_cond) || empty($usuario_perfil_cond))
      {
         $usuario_perfil_cond = "eq";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_usuario_nome = (in_array($usuario_nome_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_usuario_perfil = (in_array($usuario_perfil_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($usuario_nome) || $usuario_nome == "")
      {
          $usuario_nome = "";
      }
      ...
      if (!isset($usuario_perfil) || $usuario_perfil == "")
      {
          $usuario_perfil = "";
      }
      if (isset($usuario_perfil) && !empty($usuario_perfil))
      {
...
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_usuario_nome_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['usuario_nome'])) ? $this->New_label['usuario_nome'] : "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_nome'] . ""; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_usuario_nome_cond" name="usuario_nome_cond" onChange="nm_campos_between(document.getElementById('id_vis_usuario_nome'), this, 'usuario_nome')">
       <OPTION value="eq" <?php if ("eq" == $usuario_nome_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="qp" <?php if ("qp" == $usuario_nome_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usuario_nome" <?php echo $str_hide_usuario_nome?> valign="top">
 ...
 $nmgp_tab_label .= "usuario_nome?#?" . $SC_Label . "?@?";
 $date_sep_bw = " até ";
...
?>
<INPUT  type="text" id="SC_usuario_nome" name="usuario_nome" value="<?php echo NM_encode_input($usuario_nome) ?>"  size=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
      ...
      <TD id='SC_usuario_perfil_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['usuario_perfil'])) ? $this->New_label['usuario_perfil'] : "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_perfil'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_usuario_perfil_cond" name="usuario_perfil_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_usuario_perfil" <?php echo $str_hide_usuario_perfil?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['usuario_perfil'])) ? $this->New_label['usuario_perfil'] : "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_perfil'] . "";
 $nmgp_tab_label .= "usuario_perfil?#?" . $SC_Label . "?@?";
 $date_sep_bw = " até ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  if (!isset($usuario_perfil)) {$usuario_perfil = $usuario_perfil;}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['psq_check_ret']['usuario_perfil'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['psq_check_ret']['usuario_perfil'][] = "editor";
  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['psq_check_ret']['usuario_perfil'][] = "reporter";
  $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['psq_check_ret']['usuario_perfil'][] = "user";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontEven"><input class="scFilterObjectEven" type=radio id="SC_usuario_perfil" name="usuario_perfil" value="editor##@@Editor"  <?php if ("editor" == $usuario_perfil)  { echo " checked" ;} ?>>Editor</TD>
  <TD class="scFilterFieldFontEven"><input class="scFilterObjectEven" type=radio id="SC_usuario_perfil" name="usuario_perfil" value="reporter##@@Reporter"  <?php if ("reporter" == $usuario_perfil)  { echo " checked" ;} ?>>Reporter</TD>
  <TD class="scFilterFieldFontEven"><input class="scFilterObjectEven" type=radio id="SC_usuario_perfil" name="usuario_perfil" value="user##@@User"  <?php if ("user" == $usuario_perfil)  { echo " checked" ;} ?>>User</TD>
</TR></TABLE>
...
?>
<?php
   if (is_file("news_usuarios_cad_cons_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['news_usuarios_cad_cons']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['news_usuarios_cad_cons']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="news_usuarios_cad_cons.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 function nm_move()
 {
     ...
     document.form_cancel.action = "news_usuarios_cad_cons.php"; 
 ...
 {
   document.F1.reset();
   document.F1.usuario_nome_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_usuario_nome'), document.F1.usuario_nome_cond, 'usuario_nome');
   document.F1.usuario_nome.value = "";
   document.F1.usuario_perfil_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_usuario_perfil'), document.F1.usuario_perfil_cond, 'usuario_perfil');
   for (i = 0; i < document.F1.usuario_perfil.length; i++)
   {
      if (document.F1.usuario_perfil[i].checked)
      {
          document.F1.usuario_perfil[i].checked = false;
      }
   }
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $usuario_nome_cond, $usuario_nome,
             $usuario_perfil_cond, $usuario_perfil, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $usuario_nome_cond_salva = $usuario_nome_cond; 
      if (!isset($usuario_nome_input_2) || $usuario_nome_input_2 == "")
      {
          $usuario_nome_input_2 = $usuario_nome;
      }
      $usuario_perfil_cond_salva = $usuario_perfil_cond; 
      if (!isset($usuario_perfil_input_2) || $usuario_perfil_input_2 == "")
      {
          $usuario_perfil_input_2 = $usuario_perfil;
      }
      $tmp_pos = strpos($usuario_perfil, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $usuario_perfil;
      }
      else {
          $L_lookup = substr($usuario_perfil, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['psq_check_ret']['usuario_perfil'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_perfil'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca']['usuario_nome'] = $usuario_nome; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca']['usuario_nome_cond'] = $usuario_nome_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca']['usuario_perfil'] = $usuario_perfil; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca']['usuario_perfil_cond'] = $usuario_perfil_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $usuario_nome;
      $this->cmp_formatado['usuario_nome'] = $Conteudo;
      $this->cmp_formatado['usuario_perfil'] = $usuario_perfil;
      if (strpos($this->cmp_formatado['usuario_perfil'], "##@@") !== false)
      {
          $this->cmp_formatado['usuario_perfil'] = substr($this->cmp_formatado['usuario_perfil'], strpos($this->cmp_formatado['usuario_perfil'], "##@@") + 4);
      }
      $this->cmp_formatado['usuario_perfil_input_2'] = $usuario_perfil_input_2;

      //----- $usuario_nome
      $this->Date_part = false;
      if (isset($usuario_nome) || $usuario_nome_cond == "nu" || $usuario_nome_cond == "nn" || $usuario_nome_cond == "ep" || $usuario_nome_cond == "ne")
      {
         $this->monta_condicao("usuario_nome", $usuario_nome_cond, $usuario_nome, "", "usuario_nome");
      }

      //----- $usuario_perfil
      $this->Date_part = false;
      $usuario_perfil = $usuario_perfil; 
      if (isset($usuario_perfil))
      {
         $this->monta_condicao("usuario_perfil", $usuario_perfil_cond, $usuario_perfil, "", "usuario_perfil");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_cons']['where_pesq'];
