<?php  
  ...
  session_start() ;
  class apl_inicial_form_teste
  {
   function apl_inicial_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "apl_inicial/img";
...
?> 
<br> 
<B><FONT SIZE="4">apl_inicial</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="apl_inicial"> 
</form> 
...
<?php
  ...
  $frm_teste = new apl_inicial_form_teste();
  $frm_teste->apl_inicial_teste();
?>
