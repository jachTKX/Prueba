  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_apl_inicial_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate pula_linhas
  function do_ajax_apl_inicial_mob_validate_pula_linhas()
  {
    var nomeCampo_pula_linhas = "pula_linhas";
    var var_pula_linhas = scAjaxGetFieldHidden(nomeCampo_pula_linhas);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_apl_inicial_mob_validate_pula_linhas(var_pula_linhas, var_script_case_init, do_ajax_apl_inicial_mob_validate_pula_linhas_cb);
  } // do_ajax_apl_inicial_mob_validate_pula_linhas

  function do_ajax_apl_inicial_mob_validate_pula_linhas_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "pula_linhas";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_apl_inicial_mob_validate_pula_linhas_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_apl_inicial_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_apl_inicial_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_pula_linhas = scAjaxGetFieldHidden("pula_linhas");
    ...
    scAjaxProcOn();
    x_ajax_apl_inicial_mob_submit_form(var_pula_linhas, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_apl_inicial_mob_submit_form_cb);
  } // do_ajax_apl_inicial_mob_submit_form

  function do_ajax_apl_inicial_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pula_linhas");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_apl_inicial_mob_submit_form_cb_after_alert);
  } // do_ajax_apl_inicial_mob_submit_form_cb
  function do_ajax_apl_inicial_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_apl_inicial_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_apl_inicial_mob_navigate_form()
  {
    perform_ajax_apl_inicial_mob_navigate_form();
  }

  function perform_ajax_apl_inicial_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_apl_inicial_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['apl_inicial_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_apl_inicial_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_apl_inicial_mob_navigate_form_cb_after_alert);
  } // do_ajax_apl_inicial_mob_navigate_form_cb
  function do_ajax_apl_inicial_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_apl_inicial_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_apl_inicial_mob_navigate_form_cb_after_alert
  function sc_hide_apl_inicial_mob_form()
  {
  ...
  ajax_field_list[0] = "pula_linhas";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "pula_linhas": {"label": "pula_linhas", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "pula_linhas": new Array()
  };
  ajax_field_mult["pula_linhas"][1] = "pula_linhas";

  var ajax_field_id = {
    "pula_linhas": new Array("hidden_field_label_pula_linhas", "hidden_field_data_pula_linhas")
  };
