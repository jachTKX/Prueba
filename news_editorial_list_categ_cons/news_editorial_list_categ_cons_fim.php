   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="news_editorial_list_categ_cons.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["news_____news_editorial_list_categ_cons"]))
   {
      unset($_SESSION['session_sec_aplicacao']["news_____news_editorial_list_categ_cons"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_editorial_list_categ_cons']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['news_editorial_list_categ_cons']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_editorial_list_categ_cons']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['news_editorial_list_categ_cons']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['news_editorial_list_categ_cons']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>news_editorial_list_categ_cons</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['news_editorial_list_categ_cons']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['news_editorial_list_categ_cons']['embutida_filho'] as $ind => $sc_init)
          {
