<?php  
  ...
  session_start() ;
  class news_editorial_list_categ_cons_form_teste
  {
  function news_editorial_list_categ_cons_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">news_editorial_list_categ_cons</FONT></B> 
<br> 
<br> 
...
<input type=submit value="news_editorial_list_categ_cons"> 
</form> 
...
<?php
  ...
  $frm_teste = new news_editorial_list_categ_cons_form_teste();
  $frm_teste->news_editorial_list_categ_cons_teste();
?>
