<?php  
  ...
  session_start() ;
  class news_config_sis_frm_form_teste
  {
   function news_config_sis_frm_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "news_config_sis_frm/img";
...
?> 
<br> 
<B><FONT SIZE="4">news_config_sis_frm</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="news_config_sis_frm"> 
</form> 
...
<?php
  ...
  $frm_teste = new news_config_sis_frm_form_teste();
  $frm_teste->news_config_sis_frm_teste();
?>
