  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_config_sis_frm_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_config_sis_frm_mob_form();
	}
  ...
  // ---------- Validate news_config_pub_req_aut_editor
  function do_ajax_news_config_sis_frm_mob_validate_news_config_pub_req_aut_editor()
  {
    var nomeCampo_news_config_pub_req_aut_editor = "news_config_pub_req_aut_editor";
    var var_news_config_pub_req_aut_editor = scAjaxGetFieldCheckbox(nomeCampo_news_config_pub_req_aut_editor, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_config_sis_frm_mob_validate_news_config_pub_req_aut_editor(var_news_config_pub_req_aut_editor, var_script_case_init, do_ajax_news_config_sis_frm_mob_validate_news_config_pub_req_aut_editor_cb);
  } // do_ajax_news_config_sis_frm_mob_validate_news_config_pub_req_aut_editor

  function do_ajax_news_config_sis_frm_mob_validate_news_config_pub_req_aut_editor_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "news_config_pub_req_aut_editor";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_config_sis_frm_mob_validate_news_config_pub_req_aut_editor_cb

  // ---------- Validate news_config_noticia_dias_no_ar
  function do_ajax_news_config_sis_frm_mob_validate_news_config_noticia_dias_no_ar()
  {
    var nomeCampo_news_config_noticia_dias_no_ar = "news_config_noticia_dias_no_ar";
    var var_news_config_noticia_dias_no_ar = scAjaxGetFieldText(nomeCampo_news_config_noticia_dias_no_ar);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_config_sis_frm_mob_validate_news_config_noticia_dias_no_ar(var_news_config_noticia_dias_no_ar, var_script_case_init, do_ajax_news_config_sis_frm_mob_validate_news_config_noticia_dias_no_ar_cb);
  } // do_ajax_news_config_sis_frm_mob_validate_news_config_noticia_dias_no_ar

  function do_ajax_news_config_sis_frm_mob_validate_news_config_noticia_dias_no_ar_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "news_config_noticia_dias_no_ar";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_config_sis_frm_mob_validate_news_config_noticia_dias_no_ar_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_config_sis_frm_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_config_sis_frm_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_news_config_pub_req_aut_editor = scAjaxGetFieldCheckbox("news_config_pub_req_aut_editor", ";");
    var var_news_config_noticia_dias_no_ar = scAjaxGetFieldText("news_config_noticia_dias_no_ar");
    var var_news_config_chave_atualizacao = scAjaxGetFieldText("news_config_chave_atualizacao");
    ...
    scAjaxProcOn();
    x_ajax_news_config_sis_frm_mob_submit_form(var_news_config_pub_req_aut_editor, var_news_config_noticia_dias_no_ar, var_news_config_chave_atualizacao, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_config_sis_frm_mob_submit_form_cb);
  } // do_ajax_news_config_sis_frm_mob_submit_form

  function do_ajax_news_config_sis_frm_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("news_config_pub_req_aut_editor");
      scAjaxHideErrorDisplay("news_config_noticia_dias_no_ar");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_config_sis_frm_mob_submit_form_cb_after_alert);
  } // do_ajax_news_config_sis_frm_mob_submit_form_cb
  function do_ajax_news_config_sis_frm_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_config_sis_frm_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_config_sis_frm_mob_navigate_form()
  {
    perform_ajax_news_config_sis_frm_mob_navigate_form();
  }

  function perform_ajax_news_config_sis_frm_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("news_config_pub_req_aut_editor");
    scAjaxHideErrorDisplay("news_config_noticia_dias_no_ar");
    var var_news_config_chave_atualizacao = document.F2.news_config_chave_atualizacao.value;
    ...
    scAjaxProcOn();
    x_ajax_news_config_sis_frm_mob_navigate_form(var_news_config_chave_atualizacao, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_news_config_sis_frm_mob_navigate_form_cb);
  } // do_ajax_news_config_sis_frm_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_config_sis_frm_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_config_sis_frm_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.news_config_chave_atualizacao.value = scAjaxGetKeyValue("news_config_chave_atualizacao");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_config_sis_frm_mob_navigate_form_cb_after_alert);
  } // do_ajax_news_config_sis_frm_mob_navigate_form_cb
  function do_ajax_news_config_sis_frm_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_config_sis_frm_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_news_config_sis_frm_mob_navigate_form_cb_after_alert
  function sc_hide_news_config_sis_frm_mob_form()
  {
  ...
  ajax_field_list[0] = "news_config_pub_req_aut_editor";
  ajax_field_list[1] = "news_config_noticia_dias_no_ar";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "news_config_pub_req_aut_editor": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_config_sistema_fild_news_config_pub_req_aut_editor'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "news_config_noticia_dias_no_ar": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_config_sistema_fild_news_config_noticia_dias_no_ar'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "news_config_pub_req_aut_editor": new Array(),
    "news_config_noticia_dias_no_ar": new Array()
  };
  ajax_field_mult["news_config_pub_req_aut_editor"][1] = "news_config_pub_req_aut_editor";
  ajax_field_mult["news_config_noticia_dias_no_ar"][1] = "news_config_noticia_dias_no_ar";

  var ajax_field_id = {
    "news_config_pub_req_aut_editor": new Array("hidden_field_label_news_config_pub_req_aut_editor", "hidden_field_data_news_config_pub_req_aut_editor"),
    "news_config_noticia_dias_no_ar": new Array("hidden_field_label_news_config_noticia_dias_no_ar", "hidden_field_data_news_config_noticia_dias_no_ar")
  };

  var ajax_read_only = {
    "news_config_pub_req_aut_editor": "off",
    "news_config_noticia_dias_no_ar": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("news_config_pub_req_aut_editor" == sIndex)
    {
    ...
    if ("news_config_noticia_dias_no_ar" == sIndex)
    {
