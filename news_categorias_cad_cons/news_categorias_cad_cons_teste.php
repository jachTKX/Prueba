<?php  
  ...
  session_start() ;
  class news_categorias_cad_cons_form_teste
  {
  function news_categorias_cad_cons_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">news_categorias_cad_cons</FONT></B> 
<br> 
<br> 
...
<input type=submit value="news_categorias_cad_cons"> 
</form> 
...
<?php
  ...
  $frm_teste = new news_categorias_cad_cons_form_teste();
  $frm_teste->news_categorias_cad_cons_teste();
?>
