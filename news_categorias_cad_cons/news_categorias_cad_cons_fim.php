   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="news_categorias_cad_cons.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["news_____news_categorias_cad_cons"]))
   {
      unset($_SESSION['session_sec_aplicacao']["news_____news_categorias_cad_cons"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_categorias_cad_cons']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['news_categorias_cad_cons']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_categorias_cad_cons']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['news_categorias_cad_cons']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['news_categorias_cad_cons']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>news_categorias_cad_cons</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['news_categorias_cad_cons']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['news_categorias_cad_cons']['embutida_filho'] as $ind => $sc_init)
          {
