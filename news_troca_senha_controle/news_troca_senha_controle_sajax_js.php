  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_troca_senha_controle" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_troca_senha_controle_form();
	}
  ...
  // ---------- Validate senha
  function do_ajax_news_troca_senha_controle_validate_senha()
  {
    var nomeCampo_senha = "senha";
    var var_senha = scAjaxGetFieldText(nomeCampo_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_troca_senha_controle_validate_senha(var_senha, var_script_case_init, do_ajax_news_troca_senha_controle_validate_senha_cb);
  } // do_ajax_news_troca_senha_controle_validate_senha

  function do_ajax_news_troca_senha_controle_validate_senha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_troca_senha_controle_validate_senha_cb

  // ---------- Validate senha_nova
  function do_ajax_news_troca_senha_controle_validate_senha_nova()
  {
    var nomeCampo_senha_nova = "senha_nova";
    var var_senha_nova = scAjaxGetFieldText(nomeCampo_senha_nova);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_troca_senha_controle_validate_senha_nova(var_senha_nova, var_script_case_init, do_ajax_news_troca_senha_controle_validate_senha_nova_cb);
  } // do_ajax_news_troca_senha_controle_validate_senha_nova

  function do_ajax_news_troca_senha_controle_validate_senha_nova_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_troca_senha_controle_validate_senha_nova_cb

  // ---------- Validate conf_senha
  function do_ajax_news_troca_senha_controle_validate_conf_senha()
  {
    var nomeCampo_conf_senha = "conf_senha";
    var var_conf_senha = scAjaxGetFieldText(nomeCampo_conf_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_troca_senha_controle_validate_conf_senha(var_conf_senha, var_script_case_init, do_ajax_news_troca_senha_controle_validate_conf_senha_cb);
  } // do_ajax_news_troca_senha_controle_validate_conf_senha

  function do_ajax_news_troca_senha_controle_validate_conf_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_troca_senha_controle_validate_conf_senha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_troca_senha_controle_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_troca_senha_controle_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_news_troca_senha_controle_submit_form(var_senha, var_senha_nova, var_conf_senha, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_troca_senha_controle_submit_form_cb);
  } // do_ajax_news_troca_senha_controle_submit_form

  function do_ajax_news_troca_senha_controle_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_troca_senha_controle_submit_form_cb_after_alert);
  } // do_ajax_news_troca_senha_controle_submit_form_cb
  function do_ajax_news_troca_senha_controle_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_troca_senha_controle_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_troca_senha_controle_navigate_form()
  {
    perform_ajax_news_troca_senha_controle_navigate_form();
  }

  function perform_ajax_news_troca_senha_controle_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_news_troca_senha_controle_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_troca_senha_controle']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_troca_senha_controle_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_troca_senha_controle_navigate_form_cb_after_alert);
  } // do_ajax_news_troca_senha_controle_navigate_form_cb
  function do_ajax_news_troca_senha_controle_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_troca_senha_controle_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_news_troca_senha_controle_navigate_form_cb_after_alert
  function sc_hide_news_troca_senha_controle_form()
  {
