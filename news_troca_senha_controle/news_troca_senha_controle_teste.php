<?php  
  ...
  session_start() ;
  class news_troca_senha_controle_form_teste
  {
   function news_troca_senha_controle_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "news_troca_senha_controle/img";
...
?> 
<br> 
<B><FONT SIZE="4">news_troca_senha_controle</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="news_troca_senha_controle"> 
</form> 
<script language=javascript> 
 document.Fedit.glo_login.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new news_troca_senha_controle_form_teste();
  $frm_teste->news_troca_senha_controle_teste();
?>
