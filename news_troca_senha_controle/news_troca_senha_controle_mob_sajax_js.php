  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_troca_senha_controle_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_troca_senha_controle_mob_form();
	}
  ...
  // ---------- Validate senha
  function do_ajax_news_troca_senha_controle_mob_validate_senha()
  {
    var nomeCampo_senha = "senha";
    var var_senha = scAjaxGetFieldText(nomeCampo_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_troca_senha_controle_mob_validate_senha(var_senha, var_script_case_init, do_ajax_news_troca_senha_controle_mob_validate_senha_cb);
  } // do_ajax_news_troca_senha_controle_mob_validate_senha

  function do_ajax_news_troca_senha_controle_mob_validate_senha_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_troca_senha_controle_mob_validate_senha_cb

  // ---------- Validate senha_nova
  function do_ajax_news_troca_senha_controle_mob_validate_senha_nova()
  {
    var nomeCampo_senha_nova = "senha_nova";
    var var_senha_nova = scAjaxGetFieldText(nomeCampo_senha_nova);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_troca_senha_controle_mob_validate_senha_nova(var_senha_nova, var_script_case_init, do_ajax_news_troca_senha_controle_mob_validate_senha_nova_cb);
  } // do_ajax_news_troca_senha_controle_mob_validate_senha_nova

  function do_ajax_news_troca_senha_controle_mob_validate_senha_nova_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "senha_nova";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_troca_senha_controle_mob_validate_senha_nova_cb

  // ---------- Validate conf_senha
  function do_ajax_news_troca_senha_controle_mob_validate_conf_senha()
  {
    var nomeCampo_conf_senha = "conf_senha";
    var var_conf_senha = scAjaxGetFieldText(nomeCampo_conf_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_troca_senha_controle_mob_validate_conf_senha(var_conf_senha, var_script_case_init, do_ajax_news_troca_senha_controle_mob_validate_conf_senha_cb);
  } // do_ajax_news_troca_senha_controle_mob_validate_conf_senha

  function do_ajax_news_troca_senha_controle_mob_validate_conf_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "conf_senha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_troca_senha_controle_mob_validate_conf_senha_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_troca_senha_controle_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_troca_senha_controle_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_senha = scAjaxGetFieldText("senha");
    var var_senha_nova = scAjaxGetFieldText("senha_nova");
    var var_conf_senha = scAjaxGetFieldText("conf_senha");
    ...
    scAjaxProcOn();
    x_ajax_news_troca_senha_controle_mob_submit_form(var_senha, var_senha_nova, var_conf_senha, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_troca_senha_controle_mob_submit_form_cb);
  } // do_ajax_news_troca_senha_controle_mob_submit_form

  function do_ajax_news_troca_senha_controle_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("senha_nova");
      scAjaxHideErrorDisplay("conf_senha");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_troca_senha_controle_mob_submit_form_cb_after_alert);
  } // do_ajax_news_troca_senha_controle_mob_submit_form_cb
  function do_ajax_news_troca_senha_controle_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_troca_senha_controle_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_troca_senha_controle_mob_navigate_form()
  {
    perform_ajax_news_troca_senha_controle_mob_navigate_form();
  }

  function perform_ajax_news_troca_senha_controle_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    }
  } // do_ajax_news_troca_senha_controle_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_troca_senha_controle_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_troca_senha_controle_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_troca_senha_controle_mob_navigate_form_cb_after_alert);
  } // do_ajax_news_troca_senha_controle_mob_navigate_form_cb
  function do_ajax_news_troca_senha_controle_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_troca_senha_controle_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_news_troca_senha_controle_mob_navigate_form_cb_after_alert
  function sc_hide_news_troca_senha_controle_mob_form()
  {
  ...
  ajax_field_list[1] = "senha_nova";
  ajax_field_list[2] = "conf_senha";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "senha": {"label": "<?php echo $this->Ini->Nm_lang['lang_field_troca_senha_1'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "senha_nova": {"label": "<?php echo $this->Ini->Nm_lang['lang_field_troca_senha_2'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "conf_senha": {"label": "<?php echo $this->Ini->Nm_lang['lang_field_troca_senha_3'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "senha": new Array(),
    "senha_nova": new Array(),
    "conf_senha": new Array()
  };
  ajax_field_mult["senha"][1] = "senha";
  ajax_field_mult["senha_nova"][1] = "senha_nova";
  ajax_field_mult["conf_senha"][1] = "conf_senha";

  var ajax_field_id = {
    "senha": new Array("hidden_field_label_senha", "hidden_field_data_senha"),
    "senha_nova": new Array("hidden_field_label_senha_nova", "hidden_field_data_senha_nova"),
    "conf_senha": new Array("hidden_field_label_conf_senha", "hidden_field_data_conf_senha")
  };
