...
class news_noticias_publicar_cons_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['news_noticias_publicar_cons']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['news_noticias_publicar_cons']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
   ...
   function monta_resumo($b_export = false)
   {
     ...
     { 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['contr_total_geral'] == "OK")
      {
          $this->array_total_news_categorias_categoria_id = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['arr_total']['news_categorias_categoria_id'];
      }
      else
      {
          $this->array_total_news_categorias_categoria_id = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['arr_total']['news_categorias_categoria_id'] = $this->array_total_news_categorias_categoria_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['json_use_label'])
       {
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_data_noticia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_data_noticia'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_data_noticia'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_hora_noticia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_hora_noticia'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_hora_noticia'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_titulo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_titulo'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_titulo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_id'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_categorias_categoria_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_categorias_categoria_id'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_categoria_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_reporter_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_reporter_id'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_reporter_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_data_pub']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_data_pub'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_data_pub'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_hora_pub']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_hora_pub'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_hora_pub'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_corpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_corpo'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_corpo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_img']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_img'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_img'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_flag_man_editorial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['labels']['news_noticias_noticia_flag_man_editorial'] = ""; 
       }
       //-----
       $this->comp_field_nm = array(
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_order']['groupby_1']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_order']['groupby_1'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_order']['groupby_1'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_display']['groupby_1'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_display']['groupby_1'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_display']['groupby_1'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_display']['groupby_1'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_display']['groupby_1'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_display']['groupby_1'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['summarizing_fields_display']['groupby_1'] as $i_sum => $d_sum)
           {
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_tabular_label'];
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@news_noticias_publicar_cons@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   {
      global $nm_saida;
      $res_sem_reg = "" . $this->Ini->Nm_lang['lang_header_publicar_cons_sql'] . ""; 
      $nm_saida->saida("  <TR id=\"summary_body\">\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['ajax_nav'])
      { 
          $_SESSION['scriptcase']['saida_html'] = "";
   ...
   function inicializa_vars()
   {
      ...
      $this->Total   = new news_noticias_publicar_cons_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      ...
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['arr_total'][$cmp_gb];
      }
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "news_noticias_publicar_cons/news_noticias_publicar_cons_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_noticias_publicar_cons_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_news_noticias_publicar_cons_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_noticias_publicar_cons_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['doc_word']) 
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['embutida'])
      {
         ...
         $NM_btn = false;
         $NM_Gbtn = false;
         if (is_file("news_noticias_publicar_cons_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_html_fim()
   {
      ...
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['news_noticias_publicar_cons']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['news_noticias_publicar_cons']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'news_noticias_publicar_cons_config_pivot.php?nome_apl=news_noticias_publicar_cons&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</script>\r\n");
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"news_noticias_publicar_cons.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"news_noticias_publicar_cons.php\"\r\n");
   ...
   $nm_saida->saida("   </form> \r\n");
      ...
      $nm_saida->saida("      else\r\n");
      $nm_saida->saida("      {\r\n");
      $nm_saida->saida("          window.open(\"" . $this->Ini->path_link . "news_noticias_publicar_cons/news_noticias_publicar_cons.php?nmgp_opcao=pdf&nmgp_tipo_pdf=\" + z + \"&nmgp_parms_pdf=\" + p + \"&sc_create_charts=\" + crt + \"&nmgp_graf_pdf=\" + g + \"&SC_module_export=\" + SC_module_export + \"&use_pass_pdf=\" + use_pass_pdf + \"&pdf_all_cab=\" + pdf_all_cab + \"&pdf_all_label=\" +  pdf_all_label + \"&pdf_label_group=\" +  pdf_label_group + '&pdf_zip=' +  pdf_zip + \"&script_case_init=" . NM_encode_input($this->Ini->sc_page) . "\", \"_blank\");\r\n");
      $nm_saida->saida("      }\r\n");
      $nm_saida->saida("  }\r\n");
      $nm_saida->saida("  else\r\n");
      $nm_saida->saida("  {\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_noticias_publicar_cons_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "news_noticias_publicar_cons/news_noticias_publicar_cons_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
     ...
     elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_cons']['doc_word'] || $this->Ini->sc_export_ajax_img)
     {
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->news_noticias_noticia_id = $rs_res->fields[3] ;  
            $this->news_categorias_categoria_id = $rs_res->fields[4] ;  
...
$upd_flag = "UPDATE news_noticias
				...
				WHERE noticia_id = $news_noticias_noticia_id ";
...
$data_inicial = 
      ...
      $nm_select = "SELECT noticia_id
                                      FROM news_noticias
                                      WHERE categoria_id = $news_categorias_categoria_id   AND
                                      noticia_data_pub BETWEEN  '$data_inicial' AND '$data_final'
                                      AND noticia_flag_man_editorial='S' AND noticia_id <> $news_noticias_noticia_id  "; 
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_select; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      $id_noticia_man_choque = array();
     if ($news_categorias_categoria_id !== "" && $news_noticias_noticia_id !== "")
     { 
      if ($SCrx = $this->Db->Execute($nm_select)) 
      { 
          $SCy = 0; 
          ...
          { 
                 ...
                 for ($SCx = 0; $SCx < $nm_count; $SCx++)
                 { 
                        $id_noticia_man_choque[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
      ...
      elseif (isset($GLOBALS["NM_ERRO_IBASE"]) && $GLOBALS["NM_ERRO_IBASE"] != 1)  
      { 
          $id_noticia_man_choque = false;
          $id_noticia_man_choque_erro = $this->Db->ErrorMsg();
      } 
     } 
;

$choca = $id_noticia_man_choque[0][0];
