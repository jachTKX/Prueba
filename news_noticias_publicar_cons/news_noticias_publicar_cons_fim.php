   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="news_noticias_publicar_cons.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["news_____news_noticias_publicar_cons"]))
   {
      unset($_SESSION['session_sec_aplicacao']["news_____news_noticias_publicar_cons"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_noticias_publicar_cons']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['news_noticias_publicar_cons']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_noticias_publicar_cons']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['news_noticias_publicar_cons']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['news_noticias_publicar_cons']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>news_noticias_publicar_cons</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['news_noticias_publicar_cons']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['news_noticias_publicar_cons']['embutida_filho'] as $ind => $sc_init)
          {
