<?php
@session_start() ;
$_SESSION['scriptcase']['news_noticias_publicar_cons']['sc_process_barr'] = true;
require_once('../news_noticias_publicar_cons/index.php');
unset($_SESSION['scriptcase']['news_noticias_publicar_cons']['sc_process_barr']);
$ExportCtrl = new news_noticias_publicar_cons_export_control;
$ExportCtrl->Export_barr();

class news_noticias_publicar_cons_export_control
{
