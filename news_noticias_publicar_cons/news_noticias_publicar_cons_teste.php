<?php  
  ...
  session_start() ;
  class news_noticias_publicar_cons_form_teste
  {
  function news_noticias_publicar_cons_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">news_noticias_publicar_cons</FONT></B> 
<br> 
<br> 
...
<input type=submit value="news_noticias_publicar_cons"> 
</form> 
...
<?php
  ...
  $frm_teste = new news_noticias_publicar_cons_form_teste();
  $frm_teste->news_noticias_publicar_cons_teste();
?>
