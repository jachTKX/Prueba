...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_senha' + iSeqRow).bind('blur', function() { sc_login_senha_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_login_senha_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_login_senha_onfocus(this, iSeqRow) });
} // scJQEventsAdd
...
function sc_login_senha_onblur(oThis, iSeqRow) {
  do_ajax_login_validate_senha();
  scCssBlur(oThis);
}

function sc_login_senha_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_login_senha_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
