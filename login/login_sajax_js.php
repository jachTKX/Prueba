...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate senha
  function do_ajax_login_validate_senha()
  {
    var nomeCampo_senha = "senha";
    var var_senha = scAjaxGetFieldText(nomeCampo_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_login_validate_senha(var_senha, var_script_case_init, do_ajax_login_validate_senha_cb);
  } // do_ajax_login_validate_senha

  function do_ajax_login_validate_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "senha";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_login_validate_senha_cb
...
function scJs_sweetalert_params(params) {
  ...
  function do_ajax_login_submit_form()
  {
    ...
    x_ajax_login_submit_form(var_login, var_senha, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, var_bok, do_ajax_login_submit_form_cb);
