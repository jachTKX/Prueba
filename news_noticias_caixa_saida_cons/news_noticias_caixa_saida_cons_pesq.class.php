...
class news_noticias_caixa_saida_cons_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "noticia_id";$Nm_numeric[] = "categoria_id";$Nm_numeric[] = "reporter_id";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "noticia_data_noticia";$Nm_datas[] = "noticia_data_noticia";$Nm_datas[] = "noticia_hora_noticia";$Nm_datas[] = "noticia_hora_noticia";$Nm_datas[] = "noticia_data_pub";$Nm_datas[] = "noticia_data_pub";$Nm_datas[] = "noticia_hora_pub";$Nm_datas[] = "noticia_hora_pub";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "news_noticias_caixa_saida_cons.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_header_news_caixa_saida_cons'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>news_noticias_caixa_saida_cons/news_noticias_caixa_saida_cons_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="news_noticias_caixa_saida_cons_ajax_search.js"></script>
 <script type="text/javascript" src="news_noticias_caixa_saida_cons_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="news_noticias_caixa_saida_cons_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['news_noticias_caixa_saida_cons']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['news_noticias_caixa_saida_cons']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="news_noticias_caixa_saida_cons.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $categoria_id_cond, $categoria_id,
             $noticia_corpo_cond, $noticia_corpo,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!isset($categoria_id_cond) || empty($categoria_id_cond))
      {
         $categoria_id_cond = "eq";
      }
      if (!isset($noticia_corpo_cond) || empty($noticia_corpo_cond))
      {
         $noticia_corpo_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_categoria_id = (in_array($categoria_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_noticia_corpo = (in_array($noticia_corpo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($categoria_id, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $categoria_id = substr($categoria_id, 0, $tmp_pos);
         }
      }
      if (!isset($noticia_corpo) || $noticia_corpo == "")
      {
          $noticia_corpo = "";
      }
      if (isset($noticia_corpo) && !empty($noticia_corpo))
      {
         $tmp_pos = strpos($noticia_corpo, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $noticia_corpo = substr($noticia_corpo, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_categoria_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['categoria_id'])) ? $this->New_label['categoria_id'] : "" . $this->Ini->Nm_lang['lang_news_noticias_fild_categoria_id'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_categoria_id_cond" name="categoria_id_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_categoria_id" <?php echo $str_hide_categoria_id?> valign="top">
 ...
 $nmgp_tab_label .= "categoria_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " até ";
...
<?php
      $categoria_id_look = substr($this->Db->qstr($categoria_id), 1, -1); 
      $nmgp_def_dados = "" ; 
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['psq_check_ret']['categoria_id'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['psq_check_ret']['categoria_id'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_categoria_id">
      <SELECT class="scFilterObjectOdd" id="SC_categoria_id" name="categoria_id"  size="1">
       <OPTION value="">   - - - - - - - - - - - - - - - - - - - </OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $categoria_id)
            {
                    $categoria_id_sel = ($nm_opc_cod === $categoria_id) ? "selected" : "";
            }
            else
            {
               $categoria_id_sel = ("S" == $nm_opc_sel) ? "selected" : "";
            }
            $nm_sc_valor = $nm_opc_val;
            $nm_opc_val = $nm_sc_valor;
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $categoria_id_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_noticia_corpo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['noticia_corpo'])) ? $this->New_label['noticia_corpo'] : "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_corpo'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_noticia_corpo_cond" name="noticia_corpo_cond" onChange="nm_campos_between(document.getElementById('id_vis_noticia_corpo'), this, 'noticia_corpo')">
       <OPTION value="qp" <?php if ("qp" == $noticia_corpo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_noticia_corpo" <?php echo $str_hide_noticia_corpo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['noticia_corpo'])) ? $this->New_label['noticia_corpo'] : "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_corpo'] . "";
 $nmgp_tab_label .= "noticia_corpo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " até ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_noticia_corpo" name="noticia_corpo" value="<?php echo NM_encode_input($noticia_corpo) ?>"  size=50 alt="{datatype: 'text', maxLength: 32767, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("news_noticias_caixa_saida_cons_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['news_noticias_caixa_saida_cons']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['news_noticias_caixa_saida_cons']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="news_noticias_caixa_saida_cons.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 function nm_move()
 {
     ...
     document.form_cancel.action = "news_noticias_caixa_saida_cons.php"; 
 ...
 {
   document.F1.reset();
   document.F1.categoria_id_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_categoria_id'), document.F1.categoria_id_cond, 'categoria_id');
   document.F1.categoria_id.value = "";
   document.F1.noticia_corpo_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_noticia_corpo'), document.F1.noticia_corpo_cond, 'noticia_corpo');
   document.F1.noticia_corpo.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $categoria_id_cond, $categoria_id,
             $noticia_corpo_cond, $noticia_corpo, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $categoria_id_cond_salva = $categoria_id_cond; 
      if (!isset($categoria_id_input_2) || $categoria_id_input_2 == "")
      {
          $categoria_id_input_2 = $categoria_id;
      }
      $noticia_corpo_cond_salva = $noticia_corpo_cond; 
      if (!isset($noticia_corpo_input_2) || $noticia_corpo_input_2 == "")
      {
          $noticia_corpo_input_2 = $noticia_corpo;
      }
      $tmp_pos = strpos($categoria_id, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $categoria_id;
      }
      else {
          $L_lookup = substr($categoria_id, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['psq_check_ret']['categoria_id'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca']['categoria_id'] = $categoria_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca']['categoria_id_cond'] = $categoria_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca']['noticia_corpo'] = $noticia_corpo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca']['noticia_corpo_cond'] = $noticia_corpo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      $this->cmp_formatado['categoria_id'] = $Conteudo;
      $Conteudo = $noticia_corpo;
      $this->cmp_formatado['noticia_corpo'] = $Conteudo;

      //----- $categoria_id
      $this->Date_part = false;
      if (isset($categoria_id))
      {
         $this->monta_condicao("categoria_id", $categoria_id_cond, $categoria_id, "", "categoria_id");
      }

      //----- $noticia_corpo
      $this->Date_part = false;
      if (isset($noticia_corpo) || $noticia_corpo_cond == "nu" || $noticia_corpo_cond == "nn" || $noticia_corpo_cond == "ep" || $noticia_corpo_cond == "ne")
      {
         $this->monta_condicao("noticia_corpo", $noticia_corpo_cond, $noticia_corpo, "", "noticia_corpo");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['cond_pesq'] .= $this->NM_operador;
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['contr_array_resumo'] = "NAO";
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_caixa_saida_cons']['where_pesq'];
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "categoria_id" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
