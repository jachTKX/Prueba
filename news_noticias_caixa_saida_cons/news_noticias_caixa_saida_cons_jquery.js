...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
      type: "POST",
      url: "news_noticias_caixa_saida_cons.php",
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_news_noticias_caixa_saida_cons').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_news_noticias_caixa_saida_cons').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_news_noticias_caixa_saida_cons').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_news_noticias_caixa_saida_cons').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_news_noticias_caixa_saida_cons').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_news_noticias_caixa_saida_cons').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_news_noticias_caixa_saida_cons').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_news_noticias_caixa_saida_cons').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_news_noticias_caixa_saida_cons').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_news_noticias_caixa_saida_cons').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_news_noticias_caixa_saida_cons').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_news_noticias_caixa_saida_cons').style.width  = '0px';
        if (oResp["setValue"]) {
