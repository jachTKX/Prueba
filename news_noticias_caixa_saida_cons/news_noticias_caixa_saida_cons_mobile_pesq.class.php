...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "noticia_data_noticia";$Nm_datas[] = "noticia_data_noticia";$Nm_datas[] = "noticia_hora_noticia";$Nm_datas[] = "noticia_hora_noticia";$Nm_datas[] = "noticia_data_pub";$Nm_datas[] = "noticia_data_pub";$Nm_datas[] = "noticia_hora_pub";$Nm_datas[] = "noticia_hora_pub";$Nm_numeric[] = "noticia_id";$Nm_numeric[] = "categoria_id";$Nm_numeric[] = "reporter_id";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_categoria_id"  <?php echo $str_hide_categoria_id?>>
<?php
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_noticia_corpo_cond" name="noticia_corpo_cond" onChange="nm_campos_between(document.getElementById('id_vis_noticia_corpo'), this, 'noticia_corpo')">
       <OPTION value="qp" <?php if ("qp" == $noticia_corpo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_noticia_corpo"  <?php echo $str_hide_noticia_corpo?>><INPUT  type="text" id="SC_noticia_corpo" name="noticia_corpo" value="<?php echo NM_encode_input($noticia_corpo) ?>"  size=50 alt="{datatype: 'text', maxLength: 32767, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
