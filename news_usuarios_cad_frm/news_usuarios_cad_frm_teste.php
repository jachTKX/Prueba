<?php  
  ...
  session_start() ;
  class news_usuarios_cad_frm_form_teste
  {
   function news_usuarios_cad_frm_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "news_usuarios_cad_frm/img";
...
?> 
<br> 
<B><FONT SIZE="4">news_usuarios_cad_frm</FONT></B> 
<br> 
<br> 
...
usuario_login&nbsp;&nbsp;<input type=text name=usuario_login size=20><br> 
<input type="submit" value="news_usuarios_cad_frm"> 
</form> 
<script language=javascript> 
 document.Fedit.usuario_login.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new news_usuarios_cad_frm_form_teste();
  $frm_teste->news_usuarios_cad_frm_teste();
?>
