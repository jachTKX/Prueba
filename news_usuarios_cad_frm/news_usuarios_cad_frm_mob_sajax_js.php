  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_usuarios_cad_frm_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_usuarios_cad_frm_mob_form();
	}
  ...
  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_login()
  {
    var nomeCampo_usuario_login = "usuario_login";
    var var_usuario_login = scAjaxGetFieldText(nomeCampo_usuario_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_mob_validate_usuario_login(var_usuario_login, var_script_case_init, do_ajax_news_usuarios_cad_frm_mob_validate_usuario_login_cb);
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_login

  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_login_cb

  // ---------- Validate usuario_nome
  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_nome()
  {
    var nomeCampo_usuario_nome = "usuario_nome";
    var var_usuario_nome = scAjaxGetFieldText(nomeCampo_usuario_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_mob_validate_usuario_nome(var_usuario_nome, var_script_case_init, do_ajax_news_usuarios_cad_frm_mob_validate_usuario_nome_cb);
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_nome

  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_nome";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_nome_cb

  // ---------- Validate usuario_senha
  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_senha()
  {
    var nomeCampo_usuario_senha = "usuario_senha";
    var var_usuario_senha = scAjaxGetFieldText(nomeCampo_usuario_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_mob_validate_usuario_senha(var_usuario_senha, var_script_case_init, do_ajax_news_usuarios_cad_frm_mob_validate_usuario_senha_cb);
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_senha

  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_senha";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_senha_cb

  // ---------- Validate usuario_perfil
  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_perfil()
  {
    var nomeCampo_usuario_perfil = "usuario_perfil";
    var var_usuario_perfil = scAjaxGetFieldRadio(nomeCampo_usuario_perfil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_mob_validate_usuario_perfil(var_usuario_perfil, var_script_case_init, do_ajax_news_usuarios_cad_frm_mob_validate_usuario_perfil_cb);
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_perfil

  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_perfil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_perfil";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_perfil_cb

  // ---------- Validate usuario_email
  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_email()
  {
    var nomeCampo_usuario_email = "usuario_email";
    var var_usuario_email = scAjaxGetFieldText(nomeCampo_usuario_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_mob_validate_usuario_email(var_usuario_email, var_script_case_init, do_ajax_news_usuarios_cad_frm_mob_validate_usuario_email_cb);
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_email

  function do_ajax_news_usuarios_cad_frm_mob_validate_usuario_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usuario_email";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_mob_validate_usuario_email_cb

  // ---------- Validate categorias
  function do_ajax_news_usuarios_cad_frm_mob_validate_categorias()
  {
    var nomeCampo_categorias = "categorias";
    var var_categorias = scAjaxGetFieldCheckbox(nomeCampo_categorias, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_mob_validate_categorias(var_categorias, var_script_case_init, do_ajax_news_usuarios_cad_frm_mob_validate_categorias_cb);
  } // do_ajax_news_usuarios_cad_frm_mob_validate_categorias

  function do_ajax_news_usuarios_cad_frm_mob_validate_categorias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categorias";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_mob_validate_categorias_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_usuarios_cad_frm_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_usuarios_cad_frm_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_usuario_login = scAjaxGetFieldText("usuario_login");
    var var_usuario_nome = scAjaxGetFieldText("usuario_nome");
    var var_usuario_senha = scAjaxGetFieldText("usuario_senha");
    var var_usuario_perfil = scAjaxGetFieldRadio("usuario_perfil");
    var var_usuario_email = scAjaxGetFieldText("usuario_email");
    var var_categorias = scAjaxGetFieldCheckbox("categorias", ";");
    ...
    scAjaxProcOn();
    x_ajax_news_usuarios_cad_frm_mob_submit_form(var_usuario_login, var_usuario_nome, var_usuario_senha, var_usuario_perfil, var_usuario_email, var_categorias, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_usuarios_cad_frm_mob_submit_form_cb);
  } // do_ajax_news_usuarios_cad_frm_mob_submit_form

  function do_ajax_news_usuarios_cad_frm_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("usuario_nome");
      scAjaxHideErrorDisplay("usuario_senha");
      scAjaxHideErrorDisplay("usuario_perfil");
      scAjaxHideErrorDisplay("usuario_email");
      scAjaxHideErrorDisplay("categorias");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_usuarios_cad_frm_mob_submit_form_cb_after_alert);
  } // do_ajax_news_usuarios_cad_frm_mob_submit_form_cb
  function do_ajax_news_usuarios_cad_frm_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_usuarios_cad_frm_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_usuarios_cad_frm_mob_navigate_form()
  {
    perform_ajax_news_usuarios_cad_frm_mob_navigate_form();
  }

  function perform_ajax_news_usuarios_cad_frm_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("usuario_email");
    scAjaxHideErrorDisplay("categorias");
    var var_usuario_login = document.F2.usuario_login.value;
    ...
    scAjaxProcOn();
    x_ajax_news_usuarios_cad_frm_mob_navigate_form(var_usuario_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_news_usuarios_cad_frm_mob_navigate_form_cb);
  } // do_ajax_news_usuarios_cad_frm_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_frm_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_usuarios_cad_frm_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.usuario_login.value = scAjaxGetKeyValue("usuario_login");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_usuarios_cad_frm_mob_navigate_form_cb_after_alert);
  } // do_ajax_news_usuarios_cad_frm_mob_navigate_form_cb
  function do_ajax_news_usuarios_cad_frm_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_usuarios_cad_frm_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_news_usuarios_cad_frm_mob_navigate_form_cb_after_alert
  function sc_hide_news_usuarios_cad_frm_mob_form()
  {
  ...
  ajax_field_list[0] = "usuario_login";
  ajax_field_list[1] = "usuario_nome";
  ajax_field_list[2] = "usuario_senha";
  ajax_field_list[3] = "usuario_perfil";
  ajax_field_list[4] = "usuario_email";
  ajax_field_list[5] = "categorias";
  ...
  var ajax_error_list = {
    "usuario_login": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_login'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_nome": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_nome'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_senha": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_senha'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_perfil": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_perfil'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "usuario_email": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_usuario_fild_usuario_email'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "categorias": {"label": "<?php echo $this->Ini->Nm_lang['lang_header_cad_frm_1'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "usuario_nome": new Array(),
    "usuario_senha": new Array(),
    "usuario_perfil": new Array(),
    "usuario_email": new Array(),
    "categorias": new Array()
  };
  ajax_field_mult["usuario_login"][1] = "usuario_login";
  ajax_field_mult["usuario_nome"][1] = "usuario_nome";
  ajax_field_mult["usuario_senha"][1] = "usuario_senha";
  ajax_field_mult["usuario_perfil"][1] = "usuario_perfil";
  ajax_field_mult["usuario_email"][1] = "usuario_email";
  ajax_field_mult["categorias"][1] = "categorias";

  var ajax_field_id = {
    "usuario_login": new Array("hidden_field_label_usuario_login", "hidden_field_data_usuario_login"),
    "usuario_nome": new Array("hidden_field_label_usuario_nome", "hidden_field_data_usuario_nome"),
    "usuario_senha": new Array("hidden_field_label_usuario_senha", "hidden_field_data_usuario_senha"),
    "usuario_perfil": new Array("hidden_field_label_usuario_perfil", "hidden_field_data_usuario_perfil"),
    "usuario_email": new Array("hidden_field_label_usuario_email", "hidden_field_data_usuario_email"),
    "categorias": new Array("hidden_field_label_categorias", "hidden_field_data_categorias")
  };
