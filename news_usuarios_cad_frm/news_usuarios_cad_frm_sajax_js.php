  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_usuarios_cad_frm" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_usuarios_cad_frm_form();
	}
  ...
  function do_ajax_news_usuarios_cad_frm_validate_usuario_login()
  {
    var nomeCampo_usuario_login = "usuario_login";
    var var_usuario_login = scAjaxGetFieldText(nomeCampo_usuario_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_validate_usuario_login(var_usuario_login, var_script_case_init, do_ajax_news_usuarios_cad_frm_validate_usuario_login_cb);
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_login

  function do_ajax_news_usuarios_cad_frm_validate_usuario_login_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_login_cb

  // ---------- Validate usuario_nome
  function do_ajax_news_usuarios_cad_frm_validate_usuario_nome()
  {
    var nomeCampo_usuario_nome = "usuario_nome";
    var var_usuario_nome = scAjaxGetFieldText(nomeCampo_usuario_nome);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_validate_usuario_nome(var_usuario_nome, var_script_case_init, do_ajax_news_usuarios_cad_frm_validate_usuario_nome_cb);
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_nome

  function do_ajax_news_usuarios_cad_frm_validate_usuario_nome_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_nome_cb

  // ---------- Validate usuario_senha
  function do_ajax_news_usuarios_cad_frm_validate_usuario_senha()
  {
    var nomeCampo_usuario_senha = "usuario_senha";
    var var_usuario_senha = scAjaxGetFieldText(nomeCampo_usuario_senha);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_validate_usuario_senha(var_usuario_senha, var_script_case_init, do_ajax_news_usuarios_cad_frm_validate_usuario_senha_cb);
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_senha

  function do_ajax_news_usuarios_cad_frm_validate_usuario_senha_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_senha_cb

  // ---------- Validate usuario_perfil
  function do_ajax_news_usuarios_cad_frm_validate_usuario_perfil()
  {
    var nomeCampo_usuario_perfil = "usuario_perfil";
    var var_usuario_perfil = scAjaxGetFieldRadio(nomeCampo_usuario_perfil);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_validate_usuario_perfil(var_usuario_perfil, var_script_case_init, do_ajax_news_usuarios_cad_frm_validate_usuario_perfil_cb);
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_perfil

  function do_ajax_news_usuarios_cad_frm_validate_usuario_perfil_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_perfil_cb

  // ---------- Validate usuario_email
  function do_ajax_news_usuarios_cad_frm_validate_usuario_email()
  {
    var nomeCampo_usuario_email = "usuario_email";
    var var_usuario_email = scAjaxGetFieldText(nomeCampo_usuario_email);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_validate_usuario_email(var_usuario_email, var_script_case_init, do_ajax_news_usuarios_cad_frm_validate_usuario_email_cb);
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_email

  function do_ajax_news_usuarios_cad_frm_validate_usuario_email_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_validate_usuario_email_cb

  // ---------- Validate categorias
  function do_ajax_news_usuarios_cad_frm_validate_categorias()
  {
    var nomeCampo_categorias = "categorias";
    var var_categorias = scAjaxGetFieldCheckbox(nomeCampo_categorias, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_usuarios_cad_frm_validate_categorias(var_categorias, var_script_case_init, do_ajax_news_usuarios_cad_frm_validate_categorias_cb);
  } // do_ajax_news_usuarios_cad_frm_validate_categorias

  function do_ajax_news_usuarios_cad_frm_validate_categorias_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_usuarios_cad_frm_validate_categorias_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_usuarios_cad_frm_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_usuarios_cad_frm_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_news_usuarios_cad_frm_submit_form(var_usuario_login, var_usuario_nome, var_usuario_senha, var_usuario_perfil, var_usuario_email, var_categorias, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_usuarios_cad_frm_submit_form_cb);
  } // do_ajax_news_usuarios_cad_frm_submit_form

  function do_ajax_news_usuarios_cad_frm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_usuarios_cad_frm_submit_form_cb_after_alert);
  } // do_ajax_news_usuarios_cad_frm_submit_form_cb
  function do_ajax_news_usuarios_cad_frm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_usuarios_cad_frm_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_usuarios_cad_frm_navigate_form()
  {
    perform_ajax_news_usuarios_cad_frm_navigate_form();
  }

  function perform_ajax_news_usuarios_cad_frm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_news_usuarios_cad_frm_navigate_form(var_usuario_login, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_news_usuarios_cad_frm_navigate_form_cb);
  } // do_ajax_news_usuarios_cad_frm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_usuarios_cad_frm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_usuarios_cad_frm_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_usuarios_cad_frm_navigate_form_cb_after_alert);
  } // do_ajax_news_usuarios_cad_frm_navigate_form_cb
  function do_ajax_news_usuarios_cad_frm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_usuarios_cad_frm_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_news_usuarios_cad_frm_navigate_form_cb_after_alert
  function sc_hide_news_usuarios_cad_frm_form()
  {
