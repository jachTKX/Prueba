  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'noticia_hora_pub':
        sc_exib_ocult_pag('news_noticias_redigir_frm_mob_form0');
        break;
      case 'noticia_img':
        sc_exib_ocult_pag('news_noticias_redigir_frm_mob_form1');
        break;
    }
  }
...
function scHidePage(pageNo) {
	$("#id_news_noticias_redigir_frm_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_noticia_data_noticia" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      setTimeout(function() { do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_noticia(iSeqRow); }, 200);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_noticia_data_pub" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_pub(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_noticia_img" + iSeqRow).fileupload({
    datatype: "json",
    url: "news_noticias_redigir_frm_mob_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'news_noticias_redigir_frm_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
