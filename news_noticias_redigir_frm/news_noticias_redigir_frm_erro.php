...
$old_error_handler = set_error_handler("news_noticias_redigir_frm_scriptcase_error_handler");

function news_noticias_redigir_frm_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['news_noticias_redigir_frm']['contr_erro']) && $_SESSION['scriptcase']['news_noticias_redigir_frm']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_news_noticias_redigir_frm->contr_news_noticias_redigir_frm->Apl_com_erro = true;
            if ($inicial_news_noticias_redigir_frm->contr_news_noticias_redigir_frm->NM_ajax_flag)
            {
                $inicial_news_noticias_redigir_frm->contr_news_noticias_redigir_frm->NM_ajax_info['errList']['geral_news_noticias_redigir_frm'][] = $msg;
                return;
            }
            news_noticias_redigir_frm_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function news_noticias_redigir_frm_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['news_noticias_redigir_frm'])  && '' != $_SESSION['scriptcase']['error_icon']['news_noticias_redigir_frm'])  ? $_SESSION['scriptcase']['error_icon']['news_noticias_redigir_frm']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['news_noticias_redigir_frm']) && '' != $_SESSION['scriptcase']['error_span_title']['news_noticias_redigir_frm']) ? $_SESSION['scriptcase']['error_span_title']['news_noticias_redigir_frm'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['news_noticias_redigir_frm']) && '' != $_SESSION['scriptcase']['error_icon_title']['news_noticias_redigir_frm']) ? $_SESSION['scriptcase']['error_icon_title']['news_noticias_redigir_frm'] : '';
?>
