<?php  
  ...
  session_start() ;
  class news_noticias_redigir_frm_form_teste
  {
   function news_noticias_redigir_frm_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "news_noticias_redigir_frm/img";
...
?> 
<br> 
<B><FONT SIZE="4">news_noticias_redigir_frm</FONT></B> 
<br> 
<br> 
...
<input type="submit" value="news_noticias_redigir_frm"> 
</form> 
...
<?php
  ...
  $frm_teste = new news_noticias_redigir_frm_form_teste();
  $frm_teste->news_noticias_redigir_frm_teste();
?>
