  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_noticias_redigir_frm_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_noticias_redigir_frm_mob_form();
	}
  ...
  function do_ajax_news_noticias_redigir_frm_mob_validate_categoria_id()
  {
    var nomeCampo_categoria_id = "categoria_id";
    var var_categoria_id = scAjaxGetFieldSelect(nomeCampo_categoria_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_redigir_frm_mob_validate_categoria_id(var_categoria_id, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_validate_categoria_id_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_validate_categoria_id

  function do_ajax_news_noticias_redigir_frm_mob_validate_categoria_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "categoria_id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_redigir_frm_mob_validate_categoria_id_cb

  // ---------- Validate noticia_data_noticia
  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_noticia()
  {
    var nomeCampo_noticia_data_noticia = "noticia_data_noticia";
    var var_noticia_data_noticia = scAjaxGetFieldText(nomeCampo_noticia_data_noticia);
    var var_script_case_init = document.F1.script_case_init.value;
    setTimeout(function() {
      var var_noticia_data_noticia = scAjaxGetFieldText(nomeCampo_noticia_data_noticia);
      x_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_noticia(var_noticia_data_noticia, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_noticia_cb);
    }, 200);
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_noticia

  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_noticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noticia_data_noticia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_noticia_cb

  // ---------- Validate noticia_hora_noticia
  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_noticia()
  {
    var nomeCampo_noticia_hora_noticia = "noticia_hora_noticia";
    var var_noticia_hora_noticia = scAjaxGetFieldText(nomeCampo_noticia_hora_noticia);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_noticia(var_noticia_hora_noticia, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_noticia_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_noticia

  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_noticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noticia_hora_noticia";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_noticia_cb

  // ---------- Validate noticia_titulo
  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_titulo()
  {
    var nomeCampo_noticia_titulo = "noticia_titulo";
    var var_noticia_titulo = scAjaxGetFieldText(nomeCampo_noticia_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_redigir_frm_mob_validate_noticia_titulo(var_noticia_titulo, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_validate_noticia_titulo_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_titulo

  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noticia_titulo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_titulo_cb

  // ---------- Validate noticia_corpo
  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_corpo()
  {
    var nomeCampo_noticia_corpo = "noticia_corpo";
    var var_noticia_corpo = scAjaxGetFieldEditorHtml(nomeCampo_noticia_corpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_redigir_frm_mob_validate_noticia_corpo(var_noticia_corpo, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_validate_noticia_corpo_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_corpo

  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_corpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noticia_corpo";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_corpo_cb

  // ---------- Validate noticia_data_pub
  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_pub()
  {
    var nomeCampo_noticia_data_pub = "noticia_data_pub";
    var var_noticia_data_pub = scAjaxGetFieldText(nomeCampo_noticia_data_pub);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_pub(var_noticia_data_pub, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_pub_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_pub

  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_pub_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noticia_data_pub";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_data_pub_cb

  // ---------- Validate noticia_hora_pub
  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_pub()
  {
    var nomeCampo_noticia_hora_pub = "noticia_hora_pub";
    var var_noticia_hora_pub = scAjaxGetFieldText(nomeCampo_noticia_hora_pub);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_pub(var_noticia_hora_pub, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_pub_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_pub

  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_pub_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noticia_hora_pub";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_hora_pub_cb

  // ---------- Validate noticia_img
  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_img()
  {
    var nomeCampo_noticia_img = "noticia_img";
    var var_noticia_img = scAjaxGetFieldText(nomeCampo_noticia_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_redigir_frm_mob_validate_noticia_img(var_noticia_img, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_validate_noticia_img_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_img

  function do_ajax_news_noticias_redigir_frm_mob_validate_noticia_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noticia_img";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_redigir_frm_mob_validate_noticia_img_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_noticias_redigir_frm_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_noticias_redigir_frm_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_categoria_id = scAjaxGetFieldSelect("categoria_id");
    var var_noticia_data_noticia = scAjaxGetFieldText("noticia_data_noticia");
    var var_noticia_hora_noticia = scAjaxGetFieldText("noticia_hora_noticia");
    var var_noticia_titulo = scAjaxGetFieldText("noticia_titulo");
    var var_noticia_corpo = scAjaxGetFieldEditorHtml("noticia_corpo");
    var var_noticia_data_pub = scAjaxGetFieldText("noticia_data_pub");
    var var_noticia_hora_pub = scAjaxGetFieldText("noticia_hora_pub");
    var var_noticia_img = scAjaxGetFieldText("noticia_img");
    var var_noticia_id = scAjaxGetFieldText("noticia_id");
    var var_noticia_img_ul_name = scAjaxSpecCharProtect(document.F1.noticia_img_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_noticia_img_ul_type = document.F1.noticia_img_ul_type.value;
    var var_noticia_img_limpa = document.F1.noticia_img_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_news_noticias_redigir_frm_mob_submit_form(var_categoria_id, var_noticia_data_noticia, var_noticia_hora_noticia, var_noticia_titulo, var_noticia_corpo, var_noticia_data_pub, var_noticia_hora_pub, var_noticia_img, var_noticia_id, var_noticia_img_ul_name, var_noticia_img_ul_type, var_noticia_img_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_noticias_redigir_frm_mob_submit_form_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_submit_form

  function do_ajax_news_noticias_redigir_frm_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("categoria_id");
      scAjaxHideErrorDisplay("noticia_data_noticia");
      scAjaxHideErrorDisplay("noticia_hora_noticia");
      scAjaxHideErrorDisplay("noticia_titulo");
      scAjaxHideErrorDisplay("noticia_corpo");
      scAjaxHideErrorDisplay("noticia_data_pub");
      scAjaxHideErrorDisplay("noticia_hora_pub");
      scAjaxHideErrorDisplay("noticia_img");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.noticia_img_limpa && document.F1.noticia_img_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("noticia_img", oImgTemp, "", "", "", "N");
      }
    document.F1.noticia_img_ul_name.value = '';
    document.F1.noticia_img_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_noticias_redigir_frm_mob_submit_form_cb_after_alert);
  } // do_ajax_news_noticias_redigir_frm_mob_submit_form_cb
  function do_ajax_news_noticias_redigir_frm_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_noticias_redigir_frm_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_noticias_redigir_frm_mob_navigate_form()
  {
    perform_ajax_news_noticias_redigir_frm_mob_navigate_form();
  }

  function perform_ajax_news_noticias_redigir_frm_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("noticia_hora_pub");
    scAjaxHideErrorDisplay("noticia_img");
    var var_noticia_id = document.F2.noticia_id.value;
    ...
    scAjaxProcOn();
    x_ajax_news_noticias_redigir_frm_mob_navigate_form(var_noticia_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_news_noticias_redigir_frm_mob_navigate_form_cb);
  } // do_ajax_news_noticias_redigir_frm_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_redigir_frm_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_noticias_redigir_frm_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.noticia_id.value = scAjaxGetKeyValue("noticia_id");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_noticias_redigir_frm_mob_navigate_form_cb_after_alert);
  } // do_ajax_news_noticias_redigir_frm_mob_navigate_form_cb
  function do_ajax_news_noticias_redigir_frm_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_noticias_redigir_frm_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_news_noticias_redigir_frm_mob_navigate_form_cb_after_alert
  function sc_hide_news_noticias_redigir_frm_mob_form()
  {
  ...
  ajax_field_list[0] = "categoria_id";
  ajax_field_list[1] = "noticia_data_noticia";
  ajax_field_list[2] = "noticia_hora_noticia";
  ajax_field_list[3] = "noticia_titulo";
  ajax_field_list[4] = "noticia_corpo";
  ajax_field_list[5] = "noticia_data_pub";
  ajax_field_list[6] = "noticia_hora_pub";
  ajax_field_list[7] = "noticia_img";
  ...
  var ajax_error_list = {
    "categoria_id": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_noticias_fild_categoria_id'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "noticia_data_noticia": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_data_noticia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "noticia_hora_noticia": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_hora_noticia'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "noticia_titulo": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_titulo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "noticia_corpo": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_corpo'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "noticia_data_pub": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_data_pub'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "noticia_hora_pub": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_hora_pub'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "noticia_img": {"label": "<?php echo $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_img'] ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    "categoria_id": new Array(),
    "noticia_data_noticia": new Array(),
    "noticia_hora_noticia": new Array(),
    "noticia_titulo": new Array(),
    "noticia_corpo": new Array(),
    "noticia_data_pub": new Array(),
    "noticia_hora_pub": new Array(),
    "noticia_img": new Array()
  };
  ajax_field_mult["categoria_id"][1] = "categoria_id";
  ajax_field_mult["noticia_data_noticia"][1] = "noticia_data_noticia";
  ajax_field_mult["noticia_hora_noticia"][1] = "noticia_hora_noticia";
  ajax_field_mult["noticia_titulo"][1] = "noticia_titulo";
  ajax_field_mult["noticia_corpo"][1] = "noticia_corpo";
  ajax_field_mult["noticia_data_pub"][1] = "noticia_data_pub";
  ajax_field_mult["noticia_hora_pub"][1] = "noticia_hora_pub";
  ajax_field_mult["noticia_img"][1] = "noticia_img";

  var ajax_field_id = {
    "categoria_id": new Array("hidden_field_label_categoria_id", "hidden_field_data_categoria_id"),
    "noticia_data_noticia": new Array("hidden_field_label_noticia_data_noticia", "hidden_field_data_noticia_data_noticia"),
    "noticia_hora_noticia": new Array("hidden_field_label_noticia_hora_noticia", "hidden_field_data_noticia_hora_noticia"),
    "noticia_titulo": new Array("hidden_field_label_noticia_titulo", "hidden_field_data_noticia_titulo"),
    "noticia_corpo": new Array("hidden_field_label_noticia_corpo", "hidden_field_data_noticia_corpo"),
    "noticia_data_pub": new Array("hidden_field_label_noticia_data_pub", "hidden_field_data_noticia_data_pub"),
    "noticia_hora_pub": new Array("hidden_field_label_noticia_hora_pub", "hidden_field_data_noticia_hora_pub"),
    "noticia_img": new Array("hidden_field_label_noticia_img", "hidden_field_data_noticia_img")
  };

  var ajax_read_only = {
    "categoria_id": "off",
    "noticia_data_noticia": "off",
    "noticia_hora_noticia": "off",
    "noticia_titulo": "off",
    "noticia_corpo": "off",
    "noticia_data_pub": "off",
    "noticia_hora_pub": "off",
    "noticia_img": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("noticia_data_noticia" == sIndex)
    {
    ...
    if ("noticia_hora_noticia" == sIndex)
    {
      scAjaxSetFieldText(sIndex, aValue, "", "", true);
      updateHeaderFooter(sIndex, aValue);
