<?php  
  ...
  session_start() ;
  class news_editorial_por_sessao_cons_form_teste
  {
  function news_editorial_por_sessao_cons_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">news_editorial_por_sessao_cons</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="news_editorial_por_sessao_cons.php" 
               target="_self"> 
glo_categoria_id&nbsp;&nbsp;<input type=text name="glo_categoria_id" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="news_editorial_por_sessao_cons"> 
</form> 
<script language=javascript> 
 document.FCons.glo_categoria_id.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new news_editorial_por_sessao_cons_form_teste();
  $frm_teste->news_editorial_por_sessao_cons_teste();
?>
