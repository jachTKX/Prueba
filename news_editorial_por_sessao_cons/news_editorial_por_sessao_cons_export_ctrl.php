<?php
@session_start() ;
$_SESSION['scriptcase']['news_editorial_por_sessao_cons']['sc_process_barr'] = true;
require_once('../news_editorial_por_sessao_cons/index.php');
unset($_SESSION['scriptcase']['news_editorial_por_sessao_cons']['sc_process_barr']);
$ExportCtrl = new news_editorial_por_sessao_cons_export_control;
$ExportCtrl->Export_barr();

class news_editorial_por_sessao_cons_export_control
{
