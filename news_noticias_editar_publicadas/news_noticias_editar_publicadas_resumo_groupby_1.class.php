...
class news_noticias_editar_publicadas_resumo
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   var $link_graph_tot; 
   var $Tot_ger; 
   var $array_total_news_categorias_categoria_id;
   ...
   function __construct($tipo = "")
   {
      ...
      $this->array_total_news_categorias_categoria_id = array();
   ...
   { 
	...
	function generateChartImages() {
		...
		$chartList  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_charts'];
		$chartFiles = array();

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['phantomjs_export_process'] = true;
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_step']     = 'image';
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_count']    = 0;
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_total']    = 0;
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_total']++;
		}
		...
		foreach ($chartList as $chartKey => $chartData) {
			...
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['phantomjs_export_file'] = '';
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_count']++;

			$this->writeProgressFile();

			$this->Graf->generateChartImage($chartKey);

			if ('' != $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['phantomjs_export_file']) {
				$chartFiles[] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['phantomjs_export_file'];
			}
		}

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['phantomjs_export_process'] = false;
	...
	function zipChartImages($password = '') {
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_step'] = 'zip';

		$this->writeProgressFile();

		$zipFile = $this->zipFileList($chartImages, $password);

		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_step'] = 'end';
	...
	function zipFileList($fileList, $password = '') {
		$tempDir     = $this->Ini->root . $_SESSION['scriptcase']['news_noticias_editar_publicadas']['glo_nm_path_imag_temp'] . '/';
	...
	function writeProgressFile() {
		if ('image' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_pdff_pcht'] . ": {$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_count']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_total']}###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('zip' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_step']) {
			$progress = floor($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_count'] * 100 / ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_total'] + 1));
			$content  = $this->Ini->Nm_lang['lang_chrt_zip_img'] . "###$progress";

			$content  = $_SESSION['scriptcase']['charset'] != 'UTF-8' ? sc_convert_encoding($content, 'UTF-8', $_SESSION['scriptcase']['charset']) : $content;
		}
		elseif ('end' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_step']) {
			$content = "ok###100";
		}
		else {
			$content = "init###0";
		...
		$f = @fopen("{$this->Ini->root}{$_SESSION['scriptcase']['news_noticias_editar_publicadas']['glo_nm_path_imag_temp']}/{$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['export_progress_file']}", 'w');
		fwrite($f, $content);
		fclose($f);
	}
...
$_SESSION['scriptcase']['news_noticias_editar_publicadas']['contr_erro'] = 'off'; 
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_resumo']);
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['res_hrz']))
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['res_hrz'] = $this->NM_totaliz_hrz;
      } 
      $this->NM_totaliz_hrz = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['res_hrz'];
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['iframe_menu'] && !$this->NM_export && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['array_graf_pdf'] = array();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] != "pdf")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_resumo'] = "";
      }
      $this->inicializa_vars();
      $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['SC_Ind_Groupby'];
      $this->Total->$Gb_geral();
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['contr_array_resumo'] == "OK" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['contr_total_geral'] == "OK")
      {
          $this->array_total_news_categorias_categoria_id = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['arr_total']['news_categorias_categoria_id'];
      }
      else
      {
          $this->array_total_news_categorias_categoria_id = array();
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['tot_geral'][1]) || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['tot_geral'][1] == 0)
      {
      ...
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] == 'print' || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] == 'pdf') && strpos(" " . $this->Ini->SC_module_export, "resume") === false)
      { }
      else
      {
          $this->drawMatrix();
      ...
      $this->resumo_final();
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['contr_label_graf'] = array();
      if (isset($this->nmgp_label_quebras) && !empty($this->nmgp_label_quebras))
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['contr_label_graf'] = $this->nmgp_label_quebras;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['arr_total']['news_categorias_categoria_id'] = $this->array_total_news_categorias_categoria_id;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['contr_array_resumo'] = "OK";
   }
   ...
   function completeMatrix()
   {
       ...
       //-----
       if ($this->NM_export && isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['json_use_label']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['json_use_label'])
       {
          $Lab_news_categorias_categoria_id = "news_categorias.categoria_id";
       }
       else
       {
       $Lab_news_categorias_categoria_id = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_categoria_id'] . "";
       }
       $this->comp_field = array(
           $Lab_news_categorias_categoria_id,
       );

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_data_noticia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_data_noticia'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_data_noticia'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_hora_noticia']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_hora_noticia'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_hora_noticia'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_titulo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_titulo'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_titulo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_id'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_categorias_categoria_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_categorias_categoria_id'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_categoria_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_reporter_id']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_reporter_id'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_reporter_id'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_data_pub']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_data_pub'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_data_pub'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_hora_pub']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_hora_pub'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_hora_pub'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_corpo']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_corpo'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_corpo'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_img']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_img'] = "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_img'] . ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_flag_man_editorial']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['news_noticias_noticia_flag_man_editorial'] = ""; 
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['altera_where_data']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['labels']['altera_where_data'] = "altera_where_data"; 
       }
       //-----
       $this->comp_field_nm = array(
           'news_categorias_categoria_id' => 0,
       );
       ...
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_order']['groupby_1']))
       {
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_order']['groupby_1'][] = $i_sum;
           }
       }
       else
       {
           $this->comp_sum_order = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_order']['groupby_1'];
       }
       ...
       $this->comp_sum_display = array(
           ...
           foreach ($this->comp_sum as $i_sum => $l_sum)
           {
               if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_display']['groupby_1'][$i_sum]))
               {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_display']['groupby_1'][$i_sum] = array('label' => $l_sum, 'display' => $this->comp_sum_display[$i_sum]);
               }
               else
               {
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_display']['groupby_1'][$i_sum]['label']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_display']['groupby_1'][$i_sum]['label'] = $l_sum;
                   }
                   if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_display']['groupby_1'][$i_sum]['display']))
                   {
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_display']['groupby_1'][$i_sum]['display'] = $this->comp_sum_display[$i_sum];
                   }
               }
           }
           foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['summarizing_fields_display']['groupby_1'] as $i_sum => $d_sum)
           {
       ...
       //-----
       foreach ($this->array_total_news_categorias_categoria_id as $i_news_categorias_categoria_id => $d_news_categorias_categoria_id) {
           if (!in_array($i_news_categorias_categoria_id, $this->comp_label[0], true)) {
               $this->comp_index[0][ $d_news_categorias_categoria_id[2] ] = $d_news_categorias_categoria_id[1];
               $this->comp_label[0][ $d_news_categorias_categoria_id[2] ] = $d_news_categorias_categoria_id[1];
           }
       }
       ...
       //-----
       $this->comp_links_fl = array(
           array('name' => 'news_categorias_categoria_id', 'prot' => ''),
       );
       ...
       //-----
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_group_by'] = $this->comp_field;
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_x_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_x_axys'] = $this->comp_x_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_y_axys']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_y_axys'] = $this->comp_y_axys;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_fill']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_fill'] = $this->comp_fill;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order'] = $this->comp_order;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_start']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_start'] = $this->comp_order_start;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular'] = $this->comp_tabular;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_hover']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_hover'] = $this->comp_tabular && $this->comp_tab_hover;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_seq']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_seq'] = $this->comp_tabular && $this->comp_tab_seq;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_label']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_label'] = $this->comp_tabular && $this->comp_tab_label;
       }

       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_col']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_col'] = 0;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_level']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_level'] = -1;
       }
       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_sort']))
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_sort'] = '';
       }
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['ajax_nav'] && isset($_POST['parm']))
       { 
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_sort'] = $_POST['sort_ord'];
           if ('' == $_POST['sort_ord'])
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_col']  = 0;
           }
           ...
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_col']  = $_POST['sort_col'];
           }
       }
       if (isset($_POST['change_sort']) && 'NEW' == $_POST['change_sort']) {
           for ($i = 0; $i < sizeof($this->comp_label); $i++) {
               if ($i == $_POST['sort_col']) {
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_start'][$i] = $_POST['sort_ord'];
               }
           }
       }

       $this->comp_x_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_x_axys'];
       $this->comp_y_axys      = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_y_axys'];
       $this->comp_fill        = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_fill'];
       $this->comp_order       = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order'];
       $this->comp_order_start = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_start'];
       $this->comp_order_col   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_col'];
       $this->comp_order_level = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_level'];
       $this->comp_order_sort  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_sort'];
       $this->comp_tabular     = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular'];
       $this->comp_tab_hover   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_hover'];
       $this->comp_tab_seq     = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_seq'];
       $this->comp_tab_label   = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_tabular_label'];
       ...
       //-----
       foreach ($this->comp_label[0] as $i_news_categorias_categoria_id => $l_news_categorias_categoria_id) {
           if (isset($this->array_total_news_categorias_categoria_id[$i_news_categorias_categoria_id])) {
               $this->comp_group[$i_news_categorias_categoria_id] = array();
           }
       }
   ...
   function getCompData($level, $params = array()) {
       if (0 == $level) {
           $return = $this->array_total_news_categorias_categoria_id;
       }
   ...
   function getLabelLink($param, $i_tmp = -1, $bProtect = true)
   {
       ...
       $Md5_Res    = "@SC_par@" . NM_encode_input($this->Ini->sc_page) . "@SC_par@news_noticias_editar_publicadas@SC_par@" . md5($Parms_Res);
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['LigR_Md5'][md5($Parms_Res)] = $Parms_Res;
       return $Md5_Res;
   }
   ...
   function buildChart()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_charts']    = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_orig']      = $this->comp_chart_data;
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['comb_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['comb_table_def']  = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['anlt_table_data'] = array();
       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['anlt_table_def']  = array();
	...
	function filterChartsByGroupbyLevel() {
		...
		if (isset($nmgp_opcao) && ('pdf' == $nmgp_opcao || 'pdf_res' == $nmgp_opcao) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['chart_level']) && '' !== $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['chart_level']) {
			$applyFilter = true;
		}
		elseif (isset($nmgp_opcao) && 'image_res' == $nmgp_opcao && isset($_POST['chart_level']) && '' !== $_POST['chart_level']) {
			$applyFilter = true;
			$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['chart_level'] = $_POST['chart_level'];
		}
		...
		$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_charts'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_orig'];

		if ($applyFilter) {
			foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_charts'] as $chartIndex => $chartData) {
				...
				if ($groupbyLevel > $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['chart_level']) {
					unset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_charts'][$chartIndex]);
				}
			}
		}

		$this->comp_chart_data = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_charts'];
	}
           ...
           foreach ($a_totals as $i_total => $values)
           {
               ...
               if (isset($this->comp_chart_config[$key_config]))
               {
                   ...
                   foreach ($a_keys as $tmp_key)
                   {
                       ...
                       $xml_links[]  = $this->getFusionLink('sc_news_noticias_editar_publicadas_' . session_id() . '_!!!' . implode('_', array_merge(array($group + 1, $i_total), $link_index)) . '!!!.json');
                   }
                   ...
                   $this->comp_chart_data[$key_data]['xml']        = $this->getFusionLink('sc_news_noticias_editar_publicadas_' . session_id() . '_!!!' . implode('_', array_merge(array($group, $i_total), $param)) . '!!!.json');
   ...
   function drawMatrix()
   {
       ...
       if ($this->NM_export)
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['arr_export']['label'] = $this->build_labels;
           $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['arr_export']['data']  = $this->build_data;
           return;
       }
      ...
      $TD_padding = (!$this->Print_All && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] == "pdf") ? " style=\"padding: 0px !important;\"" : "";
      ...
      if ($this->comp_tab_hover)
      {
       ...
       foreach ($this->build_data as $row_i => $lines)
       {
           ...
           foreach ($lines as $col_i => $columns)
           {
               ...
               if (0 <= $columns['level'])
               {
                   if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] != "pdf" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['embutida'])
                   {
           ...
           if (!$b_display)
           {
               if ($this->comp_tabular)
               {
                   ...
                   foreach ($this->comp_y_axys as $iYAxysIndex)
                   {
                       ...
                       if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_start'][$iYAxysIndex]))
                       {
                           $sInitialOrder   = '';
                           $sInitialDisplay = '; display: none';
                           $sInitialSrc     = '';
                       }
                       elseif ('asc' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['pivot_order_start'][$iYAxysIndex])
                       {
...
if($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['proc_pdf'] || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['proc_pdf_vert']){ 
   ...
   function resumo_init()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         $this->monta_html_ini();
         $this->monta_cabecalho();
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] != "pdf" && !$_SESSION['scriptcase']['proc_mobile'])
         {
   ...
   function monta_css()
   {
      global $nm_saida, $nmgp_tipo_pdf, $nmgp_cor_print;
       ...
       if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['embutida'])
       {
          if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
           { 
   ...
   {
      global $nm_saida;
      $res_sem_reg = "" . $this->Ini->Nm_lang['lang_header_editar_publicadas_sql'] . ""; 
      $nm_saida->saida("  <TR id=\"summary_body\">\r\n");
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['ajax_nav'])
      { 
          $_SESSION['scriptcase']['saida_html'] = "";
      } 
      $nm_saida->saida("   <TD class=\"scGridFieldOdd scGridFieldOddFont\" align=\"center\" style=\"vertical-align: top;font-family:Tahoma, Arial, sans-serif;font-size:12px;color:#009999;\">\r\n");
   ...
   function inicializa_vars()
   {
      ...
      if ("out" == $this->NM_tipo)
      {
         require_once($this->Ini->path_aplicacao . "news_noticias_editar_publicadas_total.class.php"); 
      }
      ...
      $this->Total   = new news_noticias_editar_publicadas_total($this->Ini->sc_page);
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['LigR_Md5'] = array();
   }
   ...
   function totaliza()
   {
      $this->Total->Calc_resumo_groupby_1("res");
      foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['arr_total'] as $cmp_gb => $resto)
      {
          $Arr_tot_name = "array_total_" . $cmp_gb;
          $this->$Arr_tot_name = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['arr_total'][$cmp_gb];
      }
      ksort($this->array_total_news_categorias_categoria_id);
      if ("out" == $this->NM_tipo)
      {
         $Gb_geral = "quebra_geral_" . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['SC_Ind_Groupby'];
         $this->Total->$Gb_geral();
...
if (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['responsive_chart']['active']) {
$nm_saida->saida("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\"\r\n");
$nm_saida->saida("            \"http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd\">\r\n");
}
$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['dashboard_refresh_after_chart'] = 'resumo';
...
$nm_saida->saida("   <link rel=\"stylesheet\" type=\"text/css\" href=\"" . $this->Ini->path_link . "news_noticias_editar_publicadas/news_noticias_editar_publicadas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) . ".css\" />\r\n");
      ...
      $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_noticias_editar_publicadas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['num_css'] . '.css', 'w');
      if (($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] == "print" && strtoupper($nmgp_cor_print) == "PB") || $nmgp_tipo_pdf == "pb")
      {
      ...
      @fclose($NM_css);
     $this->Ini->summary_css = $this->Ini->path_imag_temp . '/sc_css_news_noticias_editar_publicadas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['num_css'] . '.css';
     if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] == "print")
     {
         $nm_saida->saida("  <style type=\"text/css\">\r\n");
         $NM_css = file($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_noticias_editar_publicadas_sum_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['num_css'] . '.css');
...
if ($_SESSION['scriptcase']['proc_mobile'])
{
      ...
      if (!$this->Ini->Export_html_zip && $this->Print_All && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['doc_word']) 
      {
   ...
   function monta_barra_top_normal()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao'] != "print" && !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['embutida'])
      {
         ...
         $NM_btn = false;
         $NM_Gbtn = false;
         if (is_file("news_noticias_editar_publicadas_help.txt") && !$this->grid_emb_form && !$this->NM_res_sem_reg)
         {
   ...
   function monta_barra_top_mobile()
   {
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['pdf'] == "on" && !$this->NM_res_sem_reg)
      {
          ...
          $Pdf_mod_export = "resume,chart";
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bpdf", "nm_gp_move('pdf_res', '0', 'cor', '', '', '', '', '','','$Pdf_mod_export','__APL__','N','N','S','N');", "nm_gp_move('pdf_res', '0', 'cor', '', '', '', '', '','','$Pdf_mod_export','__APL__','N','N','S','N');", "Rpdf_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "", "", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
         if ($NM_Gbtn)
      ...
      if (!$this->grid_emb_form && $this->nmgp_botoes['word'] == "on" && !$this->NM_res_sem_reg)
      {
          $nm_saida->saida("           <script type=\"text/javascript\">sc_itens_btgp_group_1_top = true;</script>\r\n");
          $nm_saida->saida("            <div class=\"scBtnGrpText scBtnGrpClick\">\r\n");
         $Cod_Btn = nmButtonOutput($this->arr_buttons, "bword", "", "", "Rword_top", "", "", "", "absmiddle", "", "0px", $this->Ini->path_botoes, "", "", "thickbox", "" . $this->Ini->path_link . "news_noticias_editar_publicadas/news_noticias_editar_publicadas_config_word.php?script_case_init=" . $this->Ini->sc_page . "&summary_export_columns=N&nm_cor=AM&nm_res_cons=s&nm_ini_word_res=resume&nm_all_modules=grid,chart,resume&password=n&origem=res&language=en_us&KeepThis=true&TB_iframe=true&modal=true", "group_1", "only_text", "text_right", "", "", "", "", "", "", "");
         $nm_saida->saida("           $Cod_Btn \r\n");
          $nm_saida->saida("            </div>\r\n");
      }
   ...
   function monta_html_fim()
   {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['print_all'])
      {
          $this->grafico_pdf();
      }
      $nm_saida->saida("</TABLE>\r\n");
      $nm_saida->saida("<link rel=\"stylesheet\" type=\"text/css\" href=\"../_lib/css/" . $this->Ini->str_schema_all . "_sweetalert.css\" />\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['news_noticias_editar_publicadas']['glo_nm_path_prod'] . "/third/sweetalert/sweetalert2.all.min.js\"></script>\r\n");
      $nm_saida->saida("<script type=\"text/javascript\" src=\"" . $_SESSION['scriptcase']['news_noticias_editar_publicadas']['glo_nm_path_prod'] . "/third/sweetalert/polyfill.min.js\"></script>\r\n");
...
{ 
      ...
      $nm_saida->saida("</TABLE>\r\n");
       ...
       $nm_saida->saida("  tb_show('', 'news_noticias_editar_publicadas_config_pivot.php?nome_apl=news_noticias_editar_publicadas&sc_page=" . NM_encode_input($this->Ini->sc_page) . "&language=en_us&TB_iframe=true&modal=true&height=300&width=500', '');\r\n");
       $nm_saida->saida("}\r\n");
       ...
       $nm_saida->saida("}\r\n");
       $nm_saida->saida("</script>\r\n");
       $nm_saida->saida("<form name=\"refresh_config\" method=\"post\" action=\"news_noticias_editar_publicadas.php\" style=\"display: none\">\r\n");
      ...
      $nm_saida->saida("<FORM name=\"F3\" method=\"post\" action=\"news_noticias_editar_publicadas.php\"\r\n");
   ...
   function monta_html_ini_pdf()
   {
      global $nm_saida;
       $tp_quebra = "";
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['num_css']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['num_css']))
       {
           $NM_css = @fopen($this->Ini->root . $this->Ini->path_imag_temp . '/sc_css_news_noticias_editar_publicadas_grid_' . $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['num_css'] . '.css', 'a');
           $NM_css_file = $this->Ini->root . $this->Ini->path_link . "news_noticias_editar_publicadas/news_noticias_editar_publicadas_res_" . strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']). ".css";
       ...
       if ($this->Print_All || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['print_all'])
       {
       $tp_quebra = "<div style=\"page-break-after: always;\"><span style=\"display: none;\">&nbsp;</span></div>";
       }
...
//--- 
   ...
   {
      global $nm_saida;
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['embutida'] || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['dashboard_info']['compact_mode'])
      { 
          return;
      } 
      ...
      { 
        ...
        if ($_SESSION['scriptcase']['charset'] != "UTF-8")
        {
          ...
          $news_categorias_categoria_id = $Busca_temp['news_categorias_categoria_id']; 
          $tmp_pos = strpos($news_categorias_categoria_id, "##@@");
          if ($tmp_pos !== false && !is_array($news_categorias_categoria_id))
          {
              $news_categorias_categoria_id = substr($news_categorias_categoria_id, 0, $tmp_pos);
          }
          $news_noticias_noticia_corpo = $Busca_temp['news_noticias_noticia_corpo']; 
          $tmp_pos = strpos($news_noticias_noticia_corpo, "##@@");
          if ($tmp_pos !== false && !is_array($news_noticias_noticia_corpo))
          {
              $news_noticias_noticia_corpo = substr($news_noticias_noticia_corpo, 0, $tmp_pos);
          }
      } 
     ...
     {
         $this->Ini->Img_export_zip[] = $this->Ini->root . $this->Ini->path_imag_cab . "/scriptcase__NM__HeaderThin20.gif";
         $img_NM_IMG_ESQ = "scriptcase__NM__HeaderThin20.gif";
     }
     elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['doc_word'] || $this->Ini->sc_export_ajax_img)
     {
         $loc_img_word = $this->Ini->root . $this->Ini->path_imag_cab . "/scriptcase__NM__HeaderThin20.gif";
         $tmp_img_word = fopen($loc_img_word, "rb");
         $reg_img_word = fread($tmp_img_word, filesize($loc_img_word));
         fclose($tmp_img_word);
         $img_NM_IMG_ESQ = "data:image/jpeg;base64," . base64_encode($reg_img_word);
     }
     else
     {
         $img_NM_IMG_ESQ = $this->NM_raiz_img . $this->Ini->path_imag_cab . "/scriptcase__NM__HeaderThin20.gif";
     }
      $nm_saida->saida("<style>\r\n");
   ...
   //---- 
   function adiciona_registro($quebra_news_categorias_categoria_id, $quebra_news_categorias_categoria_id_orig)
   {
      //----- news_categorias_categoria_id
      if (!isset($this->array_total_news_categorias_categoria_id[$quebra_news_categorias_categoria_id_orig]))
      {
         $this->array_total_news_categorias_categoria_id[$quebra_news_categorias_categoria_id_orig][0] = 1;
         $this->array_total_news_categorias_categoria_id[$quebra_news_categorias_categoria_id_orig][1] = $quebra_news_categorias_categoria_id;
         $this->array_total_news_categorias_categoria_id[$quebra_news_categorias_categoria_id_orig][2] = $quebra_news_categorias_categoria_id_orig;
      }
      else
      {
         $this->array_total_news_categorias_categoria_id[$quebra_news_categorias_categoria_id_orig][0]++;
      }
   }
...
$_SESSION['scriptcase']['news_noticias_editar_publicadas']['contr_erro'] = 'off'; 
     ...
     $campos_order = "";
     $format       = $this->Ini->Get_Gb_date_format('', 'news_categorias_categoria_id');
     $campos_order = $this->Ini->Get_date_order_groupby("news_categorias.categoria_id", 'asc', $format, $campos_order);
...
// 
   function nm_acum_res_unit($rs_res, $nm_tipo="resumo")
   {
            ...
            $this->news_noticias_noticia_data_noticia = $rs_res->fields[0] ;  
            $this->news_noticias_noticia_hora_noticia = $rs_res->fields[1] ;  
            $this->news_noticias_noticia_titulo = $rs_res->fields[2] ;  
            $this->news_categorias_categoria_id = $rs_res->fields[3] ;  
            $this->news_noticias_noticia_id = $rs_res->fields[4] ;  
            $this->look_news_categorias_categoria_id = $this->news_categorias_categoria_id; 
            $this->Lookup->lookup_news_categorias_categoria_id($this->look_news_categorias_categoria_id) ; 
            $this->news_categorias_categoria_id_orig = $this->news_categorias_categoria_id;
            $this->news_categorias_categoria_id = $this->look_news_categorias_categoria_id ;
            if ($nm_tipo == "resumo")
            {
                $this->adiciona_registro($this->news_categorias_categoria_id, $this->news_categorias_categoria_id_orig);
            }
   }
//
...
$_SESSION['scriptcase']['news_noticias_editar_publicadas']['contr_erro'] = 'on';
      ...
      { 
          ...
          { 
                 ...
                 { 
                        $qt_dias[$SCy] [$SCx] = $SCrx->fields[$SCx];
                 }
                 $SCy++; 
                 $SCrx->MoveNext();
          } 
