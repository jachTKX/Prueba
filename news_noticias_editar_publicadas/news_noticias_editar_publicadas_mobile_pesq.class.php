...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_news_categorias_categoria_id"  <?php echo $str_hide_news_categorias_categoria_id?>>
<?php
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_news_noticias_noticia_corpo_cond" name="news_noticias_noticia_corpo_cond" onChange="nm_campos_between(document.getElementById('id_vis_news_noticias_noticia_corpo'), this, 'news_noticias_noticia_corpo')">
       <OPTION value="qp" <?php if ("qp" == $news_noticias_noticia_corpo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
      <br><span id="id_hide_news_noticias_noticia_corpo"  <?php echo $str_hide_news_noticias_noticia_corpo?>><INPUT  type="text" id="SC_news_noticias_noticia_corpo" name="news_noticias_noticia_corpo" value="<?php echo NM_encode_input($news_noticias_noticia_corpo) ?>"  size=50 alt="{datatype: 'text', maxLength: 32767, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
