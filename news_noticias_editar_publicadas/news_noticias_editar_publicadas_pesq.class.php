...
class news_noticias_editar_publicadas_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "news_noticias_noticia_id";$Nm_numeric[] = "news_categorias_categoria_id";$Nm_numeric[] = "news_noticias_reporter_id";
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
         ...
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['decimal_db'] == ".")
         {
            $nm_aspas  = "";
            $nm_aspas1 = "";
         }
      ...
      $Nm_datas[] = "news_noticias.noticia_data_noticia";$Nm_datas[] = "news_noticias_noticia_data_noticia";$Nm_datas[] = "news_noticias.noticia_hora_noticia";$Nm_datas[] = "news_noticias_noticia_hora_noticia";$Nm_datas[] = "news_noticias.noticia_data_pub";$Nm_datas[] = "news_noticias_noticia_data_pub";$Nm_datas[] = "news_noticias.noticia_hora_pub";$Nm_datas[] = "news_noticias_noticia_hora_pub";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['SC_sep_date']))
          {
              $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['SC_sep_date'];
              $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['SC_sep_date1'];
          }
      }
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "news_noticias_editar_publicadas.php";
?>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN"
            "http://www.w3.org/TR/1999/REC-html401-19991224/loose.dtd">
<HTML>
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_header_editar_publicadas'] ?></TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>news_noticias_editar_publicadas/news_noticias_editar_publicadas_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="news_noticias_editar_publicadas_ajax_search.js"></script>
 <script type="text/javascript" src="news_noticias_editar_publicadas_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="news_noticias_editar_publicadas_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['news_noticias_editar_publicadas']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['news_noticias_editar_publicadas']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
<script type="text/javascript">
 ...
 <FORM name="F1" action="news_noticias_editar_publicadas.php" method="post" target="_self"> 
 <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $news_categorias_categoria_id_cond, $news_categorias_categoria_id,
             $news_noticias_noticia_corpo_cond, $news_noticias_noticia_corpo,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!isset($news_categorias_categoria_id_cond) || empty($news_categorias_categoria_id_cond))
      {
         $news_categorias_categoria_id_cond = "eq";
      }
      if (!isset($news_noticias_noticia_corpo_cond) || empty($news_noticias_noticia_corpo_cond))
      {
         $news_noticias_noticia_corpo_cond = "qp";
      }
      $display_aberto  = "style=display:";
      $display_fechado = "style=display:none";
      $opc_hide_input = array("nu","nn","ep","ne");
      $str_hide_news_categorias_categoria_id = (in_array($news_categorias_categoria_id_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_news_noticias_noticia_corpo = (in_array($news_noticias_noticia_corpo_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      if (!isset($news_categorias_categoria_id) || $news_categorias_categoria_id == "")
      {
          $news_categorias_categoria_id = "";
      }
      if (isset($news_categorias_categoria_id) && !empty($news_categorias_categoria_id))
      {
      ...
      if (!isset($news_noticias_noticia_corpo) || $news_noticias_noticia_corpo == "")
      {
          $news_noticias_noticia_corpo = "";
      }
      if (isset($news_noticias_noticia_corpo) && !empty($news_noticias_noticia_corpo))
      {
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_news_categorias_categoria_id_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['news_categorias_categoria_id'])) ? $this->New_label['news_categorias_categoria_id'] : "" . $this->Ini->Nm_lang['lang_news_noticias_fild_categoria_id'] . ""; ?></TD>
      
      <INPUT type="hidden" id="SC_news_categorias_categoria_id_cond" name="news_categorias_categoria_id_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_news_categorias_categoria_id" <?php echo $str_hide_news_categorias_categoria_id?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['news_categorias_categoria_id'])) ? $this->New_label['news_categorias_categoria_id'] : "" . $this->Ini->Nm_lang['lang_news_noticias_fild_categoria_id'] . "";
 $nmgp_tab_label .= "news_categorias_categoria_id?#?" . $SC_Label . "?@?";
 $date_sep_bw = " até ";
...
<?php
      ...
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['psq_check_ret']['news_categorias_categoria_id'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['psq_check_ret']['news_categorias_categoria_id'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_news_categorias_categoria_id">
      <SELECT class="scFilterObjectOdd" id="SC_news_categorias_categoria_id" name="news_categorias_categoria_id"  size="1">
       <OPTION value="">   - - - - - - - - - - - - - - - - - - - </OPTION>
<?php
      ...
      foreach ($nm_opcoes as $nm_opcao)
      {
         if (!empty($nm_opcao))
         {
            ...
            if ("" != $news_categorias_categoria_id)
            {
                    $news_categorias_categoria_id_sel = ($nm_opc_cod === $news_categorias_categoria_id) ? "selected" : "";
            }
            else
            {
...
?>
       <OPTION value="<?php echo NM_encode_input($nm_opc_cod . $delimitador . $nm_opc_val); ?>" <?php echo $news_categorias_categoria_id_sel; ?>><?php echo $nm_opc_val; ?></OPTION>
<?php
         }
      }
?>
...
?>
      ...
      <TD id='SC_news_noticias_noticia_corpo_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['news_noticias_noticia_corpo'])) ? $this->New_label['news_noticias_noticia_corpo'] : "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_corpo'] . ""; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_news_noticias_noticia_corpo_cond" name="news_noticias_noticia_corpo_cond" onChange="nm_campos_between(document.getElementById('id_vis_news_noticias_noticia_corpo'), this, 'news_noticias_noticia_corpo')">
       <OPTION value="qp" <?php if ("qp" == $news_noticias_noticia_corpo_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_news_noticias_noticia_corpo" <?php echo $str_hide_news_noticias_noticia_corpo?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['news_noticias_noticia_corpo'])) ? $this->New_label['news_noticias_noticia_corpo'] : "" . $this->Ini->Nm_lang['lang_news_noticias_fild_noticia_corpo'] . "";
 $nmgp_tab_label .= "news_noticias_noticia_corpo?#?" . $SC_Label . "?@?";
 $date_sep_bw = " até ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_news_noticias_noticia_corpo" name="news_noticias_noticia_corpo" value="<?php echo NM_encode_input($news_noticias_noticia_corpo) ?>"  size=50 alt="{datatype: 'text', maxLength: 32767, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
?>
<?php
   if (is_file("news_noticias_editar_publicadas_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['news_noticias_editar_publicadas']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['news_noticias_editar_publicadas']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
<?php
   ...
   {
?>
   <FORM style="display:none;" name="form_cancel"  method="POST" action="news_noticias_editar_publicadas.php" target="_self"> 
<?php
   }
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['orig_pesq'] == "grid")
   {
...
<SCRIPT type="text/javascript">
 function nm_move()
 {
     ...
     document.form_cancel.action = "news_noticias_editar_publicadas.php"; 
 ...
 {
   document.F1.reset();
   document.F1.news_categorias_categoria_id_cond.value = 'eq';
   nm_campos_between(document.getElementById('id_vis_news_categorias_categoria_id'), document.F1.news_categorias_categoria_id_cond, 'news_categorias_categoria_id');
   document.F1.news_categorias_categoria_id.value = "";
   document.F1.news_noticias_noticia_corpo_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_news_noticias_noticia_corpo'), document.F1.news_noticias_noticia_corpo_cond, 'news_noticias_noticia_corpo');
   document.F1.news_noticias_noticia_corpo.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   {
      global $news_categorias_categoria_id_cond, $news_categorias_categoria_id,
             $news_noticias_noticia_corpo_cond, $news_noticias_noticia_corpo, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $news_categorias_categoria_id_cond_salva = $news_categorias_categoria_id_cond; 
      if (!isset($news_categorias_categoria_id_input_2) || $news_categorias_categoria_id_input_2 == "")
      {
          $news_categorias_categoria_id_input_2 = $news_categorias_categoria_id;
      }
      $news_noticias_noticia_corpo_cond_salva = $news_noticias_noticia_corpo_cond; 
      if (!isset($news_noticias_noticia_corpo_input_2) || $news_noticias_noticia_corpo_input_2 == "")
      {
          $news_noticias_noticia_corpo_input_2 = $news_noticias_noticia_corpo;
      }
      $tmp_pos = strpos($news_categorias_categoria_id, "##@@");
      if ($tmp_pos === false) {
          $L_lookup = $news_categorias_categoria_id;
      }
      else {
          $L_lookup = substr($news_categorias_categoria_id, 0, $tmp_pos);
      }
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['psq_check_ret']['news_categorias_categoria_id'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "" . $this->Ini->Nm_lang['lang_news_noticias_fild_categoria_id'] . " : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca']['news_categorias_categoria_id'] = $news_categorias_categoria_id; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca']['news_categorias_categoria_id_cond'] = $news_categorias_categoria_id_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca']['news_noticias_noticia_corpo'] = $news_noticias_noticia_corpo; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca']['news_noticias_noticia_corpo_cond'] = $news_noticias_noticia_corpo_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['dyn_search']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      }
      $Conteudo = $news_categorias_categoria_id;
      if (strpos($Conteudo, "##@@") !== false)
      {
          $Conteudo = substr($Conteudo, strpos($Conteudo, "##@@") + 4);
      }
      $this->cmp_formatado['news_categorias_categoria_id'] = $Conteudo;
      $Conteudo = $news_noticias_noticia_corpo;
      $this->cmp_formatado['news_noticias_noticia_corpo'] = $Conteudo;

      //----- $news_categorias_categoria_id
      $this->Date_part = false;
      if (isset($news_categorias_categoria_id))
      {
         $this->monta_condicao("news_categorias.categoria_id", $news_categorias_categoria_id_cond, $news_categorias_categoria_id, "", "news_categorias_categoria_id");
      }

      //----- $news_noticias_noticia_corpo
      $this->Date_part = false;
      if (isset($news_noticias_noticia_corpo) || $news_noticias_noticia_corpo_cond == "nu" || $news_noticias_noticia_corpo_cond == "nn" || $news_noticias_noticia_corpo_cond == "ep" || $news_noticias_noticia_corpo_cond == "ne")
      {
         $this->monta_condicao("news_noticias.noticia_corpo", $news_noticias_noticia_corpo_cond, $news_noticias_noticia_corpo, "", "news_noticias_noticia_corpo");
      }
   }
   ...
   function finaliza_resultado()
   {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_pesq']         = $this->comando . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['opcao']              = "pesq";
      if ("" == $this->comando_filtro)
      {
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['cond_pesq'] .= $this->NM_operador;
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_pesq_ant'] = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_editar_publicadas']['where_pesq'];
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "news_categorias_categoria_id" : return ('class="scFilterObjectOdd"'); break;
         default       : return ("");
      }
   }
