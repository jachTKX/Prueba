<?php  
  ...
  session_start() ;
  class news_noticias_editar_publicadas_form_teste
  {
  function news_noticias_editar_publicadas_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">news_noticias_editar_publicadas</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="news_noticias_editar_publicadas.php" 
               target="_self"> 
glo_login&nbsp;&nbsp;<input type=text name="glo_login" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="news_noticias_editar_publicadas"> 
</form> 
<script language=javascript> 
 document.FCons.glo_login.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new news_noticias_editar_publicadas_form_teste();
  $frm_teste->news_noticias_editar_publicadas_teste();
?>
