<?php
@session_start() ;
$_SESSION['scriptcase']['news_noticias_editar_publicadas']['sc_process_barr'] = true;
require_once('../news_noticias_editar_publicadas/index.php');
unset($_SESSION['scriptcase']['news_noticias_editar_publicadas']['sc_process_barr']);
$ExportCtrl = new news_noticias_editar_publicadas_export_control;
$ExportCtrl->Export_barr();

class news_noticias_editar_publicadas_export_control
{
