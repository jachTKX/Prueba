<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['news_detalhes_noticia']['glo_nm_path_imag_temp'] . "/sc_apl_default_news.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new news_detalhes_noticia_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class news_detalhes_noticia_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['categoria_id'] = "categoria_id";
   $tab_labels["categoria_id"]   = (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["categoria_id"])) ? $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["categoria_id"] : "" . $this->Nm_lang['lang_news_noticias_fild_categoria_id'] . "";
   $tab_ger_campos['noticia_titulo'] = "on";
   $tab_def_campos['noticia_titulo'] = "noticia_titulo";
   $tab_labels["noticia_titulo"]   = (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["noticia_titulo"])) ? $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["noticia_titulo"] : "" . $this->Nm_lang['lang_news_noticias_fild_noticia_titulo'] . "";
   $tab_ger_campos['noticia_img'] = "on";
   $tab_def_campos['noticia_img'] = "noticia_img";
   $tab_labels["noticia_img"]   = (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["noticia_img"])) ? $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["noticia_img"] : "" . $this->Nm_lang['lang_news_noticias_fild_noticia_img'] . "";
   $tab_ger_campos['noticia_data_pub'] = "on";
   $tab_def_campos['noticia_data_pub'] = "noticia_data_pub";
   $tab_labels["noticia_data_pub"]   = (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["noticia_data_pub"])) ? $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["noticia_data_pub"] : "" . $this->Nm_lang['lang_news_noticias_fild_noticia_data_pub'] . "";
   $tab_ger_campos['reporter_id'] = "on";
   $tab_def_campos['reporter_id'] = "reporter_id";
   $tab_labels["reporter_id"]   = (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["reporter_id"])) ? $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["reporter_id"] : "" . $this->Nm_lang['lang_news_noticias_fild_reporter_id'] . "";
   $tab_ger_campos['noticia_corpo'] = "on";
   $tab_def_campos['noticia_corpo'] = "noticia_corpo";
   $tab_labels["noticia_corpo"]   = (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["noticia_corpo"])) ? $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["noticia_corpo"] : "" . $this->Nm_lang['lang_news_noticias_fild_noticia_corpo'] . "";
   $tab_ger_campos['campo1'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['campo1'] = "campo1";
   }
   else
   {
       $tab_def_campos['campo1'] = "";
   }
   $tab_labels["campo1"]   = (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["campo1"])) ? $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['labels']["campo1"] : "";
   $tab_ger_campos['noticia_img'] = "none";
   $tab_ger_campos['campo1'] = "none";
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['news_detalhes_noticia']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['news_detalhes_noticia']['field_display']))
   {
       foreach ($_SESSION['scriptcase']['sc_apl_conf']['news_detalhes_noticia']['field_display'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_tble_news_noticias'] ?></TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "news_detalhes_noticia_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['news_detalhes_noticia']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
