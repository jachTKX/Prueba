<?php  
  ...
  session_start() ;
  class news_detalhes_noticia_form_teste
  {
  function news_detalhes_noticia_teste()
  {
...
?> 
<br> 
<B><FONT SIZE="4">news_detalhes_noticia</FONT></B> 
<br> 
<br> 
<form name="FCons" method=post 
               action="news_detalhes_noticia.php" 
               target="_self"> 
glo_noticia_id&nbsp;&nbsp;<input type=text name="glo_noticia_id" size=20><br> 
<input type="hidden" name="nmgp_outra_jan" value="true"/>
<input type="hidden" name="nmgp_start" value="SC"/>
<input type=hidden name="NM_contr_var_session" value="Yes"> 
<input type=submit value="news_detalhes_noticia"> 
</form> 
<script language=javascript> 
 document.FCons.glo_noticia_id.focus(); 
</script> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new news_detalhes_noticia_form_teste();
  $frm_teste->news_detalhes_noticia_teste();
?>
