   ...
   <html>
    <body>
     <form name="F0" method=post
                  target="_self"
                  action="news_detalhes_noticia.php">
     </form>
...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["news_____news_detalhes_noticia"]))
   {
      unset($_SESSION['session_sec_aplicacao']["news_____news_detalhes_noticia"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_detalhes_noticia']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['news_detalhes_noticia']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['news_detalhes_noticia']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['news_detalhes_noticia']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['news_detalhes_noticia']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>news_detalhes_noticia</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['news_detalhes_noticia']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['news_detalhes_noticia']['embutida_filho'] as $ind => $sc_init)
          {
