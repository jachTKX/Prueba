<?php
@session_start() ;
$_SESSION['scriptcase']['news_detalhes_noticia']['sc_process_barr'] = true;
require_once('../news_detalhes_noticia/index.php');
unset($_SESSION['scriptcase']['news_detalhes_noticia']['sc_process_barr']);
$ExportCtrl = new news_detalhes_noticia_export_control;
$ExportCtrl->Export_barr();

class news_detalhes_noticia_export_control
{
