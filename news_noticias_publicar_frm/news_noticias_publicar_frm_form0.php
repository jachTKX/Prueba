...
?>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("news_noticias_publicar_frm_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('news_noticias_publicar_frm_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['remove_border']) && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['remove_border'] ? 'border-width: 0; ' : '';
    $vertical_center = '';
?>
...
<?php
 include_once("news_noticias_publicar_frm_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" enctype="multipart/form-data" 
               action="news_noticias_publicar_frm.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['news_noticias_publicar_frm'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['news_noticias_publicar_frm'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] != "R")
{
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "news_noticias_publicar_frm_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'news_noticias_publicar_frm_form0' => array(
            'title' => "{lang_tab_news_redigir_frm_1}",
            'class' => empty($nmgp_num_form) || $nmgp_num_form == "news_noticias_publicar_frm_form0" ? "scTabActive" : "scTabInactive",
        ),
        'news_noticias_publicar_frm_form1' => array(
            'title' => "{lang_tab_news_redigir_frm_2}",
            'class' => $nmgp_num_form == "news_noticias_publicar_frm_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('{lang_tab_news_redigir_frm_1}' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['news_noticias_publicar_frm_form0']['class'] = 'scTabInactive';
                        }
                        if ('{lang_tab_news_redigir_frm_2}' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['news_noticias_publicar_frm_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["news_noticias_publicar_frm_form0"]['class'];
?>
   <li id="id_news_noticias_publicar_frm_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('news_noticias_publicar_frm_form0')">
     <?php echo $this->Ini->Nm_lang['lang_tab_news_redigir_frm_1']; ?>
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["news_noticias_publicar_frm_form1"]['class'];
?>
   <li id="id_news_noticias_publicar_frm_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('news_noticias_publicar_frm_form1')">
...
<div id="news_noticias_publicar_frm_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['Lookup_noticia_flag_man_editorial'][] = 'N'; ?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['Lookup_noticia_flag_man_editorial'][] = 'S'; ?>
...
<?php $sStyleHidden_categoria_id_dumb = ('' == $sStyleHidden_categoria_id) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_categoria_id_dumb" style="<?php echo $sStyleHidden_categoria_id_dumb; ?>"></TD>
<?php $sStyleHidden_noticia_data_noticia_dumb = ('' == $sStyleHidden_noticia_data_noticia) ? 'display: none' : ''; ?>
    <TD class="scFormDataOdd" id="hidden_field_data_noticia_data_noticia_dumb" style="<?php echo $sStyleHidden_noticia_data_noticia_dumb; ?>"></TD>
