<div id="news_noticias_publicar_frm_form1" style='<?php echo ($this->tabCssClass["news_noticias_publicar_frm_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<script> 
<?php
 $NM_pag_atual = "news_noticias_publicar_frm_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "news_noticias_publicar_frm_form" . $this->nmgp_ancora;
 }
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("news_noticias_publicar_frm");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("news_noticias_publicar_frm");
 parent.scAjaxDetailHeight("news_noticias_publicar_frm", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
