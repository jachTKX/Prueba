  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_noticias_publicar_frm" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_noticias_publicar_frm_form();
	}
  ...
  function do_ajax_news_noticias_publicar_frm_validate_categoria_id()
  {
    var nomeCampo_categoria_id = "categoria_id";
    var var_categoria_id = scAjaxGetFieldSelect(nomeCampo_categoria_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_validate_categoria_id(var_categoria_id, var_script_case_init, do_ajax_news_noticias_publicar_frm_validate_categoria_id_cb);
  } // do_ajax_news_noticias_publicar_frm_validate_categoria_id

  function do_ajax_news_noticias_publicar_frm_validate_categoria_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_validate_categoria_id_cb

  // ---------- Validate noticia_data_noticia
  function do_ajax_news_noticias_publicar_frm_validate_noticia_data_noticia()
  {
    ...
    setTimeout(function() {
      var var_noticia_data_noticia = scAjaxGetFieldText(nomeCampo_noticia_data_noticia);
      x_ajax_news_noticias_publicar_frm_validate_noticia_data_noticia(var_noticia_data_noticia, var_script_case_init, do_ajax_news_noticias_publicar_frm_validate_noticia_data_noticia_cb);
    }, 200);
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_data_noticia

  function do_ajax_news_noticias_publicar_frm_validate_noticia_data_noticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_data_noticia_cb

  // ---------- Validate noticia_hora_noticia
  function do_ajax_news_noticias_publicar_frm_validate_noticia_hora_noticia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_validate_noticia_hora_noticia(var_noticia_hora_noticia, var_script_case_init, do_ajax_news_noticias_publicar_frm_validate_noticia_hora_noticia_cb);
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_hora_noticia

  function do_ajax_news_noticias_publicar_frm_validate_noticia_hora_noticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_hora_noticia_cb

  // ---------- Validate noticia_flag_man_editorial
  function do_ajax_news_noticias_publicar_frm_validate_noticia_flag_man_editorial()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_validate_noticia_flag_man_editorial(var_noticia_flag_man_editorial, var_script_case_init, do_ajax_news_noticias_publicar_frm_validate_noticia_flag_man_editorial_cb);
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_flag_man_editorial

  function do_ajax_news_noticias_publicar_frm_validate_noticia_flag_man_editorial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_flag_man_editorial_cb

  // ---------- Validate noticia_titulo
  function do_ajax_news_noticias_publicar_frm_validate_noticia_titulo()
  {
    var nomeCampo_noticia_titulo = "noticia_titulo";
    var var_noticia_titulo = scAjaxGetFieldText(nomeCampo_noticia_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_validate_noticia_titulo(var_noticia_titulo, var_script_case_init, do_ajax_news_noticias_publicar_frm_validate_noticia_titulo_cb);
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_titulo

  function do_ajax_news_noticias_publicar_frm_validate_noticia_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_titulo_cb

  // ---------- Validate noticia_corpo
  function do_ajax_news_noticias_publicar_frm_validate_noticia_corpo()
  {
    var nomeCampo_noticia_corpo = "noticia_corpo";
    var var_noticia_corpo = scAjaxGetFieldEditorHtml(nomeCampo_noticia_corpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_validate_noticia_corpo(var_noticia_corpo, var_script_case_init, do_ajax_news_noticias_publicar_frm_validate_noticia_corpo_cb);
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_corpo

  function do_ajax_news_noticias_publicar_frm_validate_noticia_corpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_corpo_cb

  // ---------- Validate noticia_img
  function do_ajax_news_noticias_publicar_frm_validate_noticia_img()
  {
    var nomeCampo_noticia_img = "noticia_img";
    var var_noticia_img = scAjaxGetFieldText(nomeCampo_noticia_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_validate_noticia_img(var_noticia_img, var_script_case_init, do_ajax_news_noticias_publicar_frm_validate_noticia_img_cb);
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_img

  function do_ajax_news_noticias_publicar_frm_validate_noticia_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_validate_noticia_img_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_noticias_publicar_frm_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_noticias_publicar_frm_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_news_noticias_publicar_frm_submit_form(var_categoria_id, var_noticia_data_noticia, var_noticia_hora_noticia, var_noticia_flag_man_editorial, var_noticia_titulo, var_noticia_corpo, var_noticia_img, var_noticia_img_ul_name, var_noticia_img_ul_type, var_noticia_img_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_noticias_publicar_frm_submit_form_cb);
  } // do_ajax_news_noticias_publicar_frm_submit_form

  function do_ajax_news_noticias_publicar_frm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_noticias_publicar_frm_submit_form_cb_after_alert);
  } // do_ajax_news_noticias_publicar_frm_submit_form_cb
  function do_ajax_news_noticias_publicar_frm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_noticias_publicar_frm_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_noticias_publicar_frm_navigate_form()
  {
    perform_ajax_news_noticias_publicar_frm_navigate_form();
  }

  function perform_ajax_news_noticias_publicar_frm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_news_noticias_publicar_frm_navigate_form(var_noticia_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_news_noticias_publicar_frm_navigate_form_cb);
  } // do_ajax_news_noticias_publicar_frm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_noticias_publicar_frm_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_noticias_publicar_frm_navigate_form_cb_after_alert);
  } // do_ajax_news_noticias_publicar_frm_navigate_form_cb
  function do_ajax_news_noticias_publicar_frm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_noticias_publicar_frm_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_news_noticias_publicar_frm_navigate_form_cb_after_alert
  function sc_hide_news_noticias_publicar_frm_form()
  {
