...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="news_noticias_publicar_frm"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm']['where_detal']))
  {
?>  
...
{
    document.getElementById('news_noticias_publicar_frm_form0').style.width='1px';
    document.getElementById('news_noticias_publicar_frm_form0').style.height='0px';
    document.getElementById('news_noticias_publicar_frm_form0').style.display='none';
    document.getElementById('news_noticias_publicar_frm_form0').style.overflow='scroll';
    document.getElementById('news_noticias_publicar_frm_form1').style.width='1px';
    document.getElementById('news_noticias_publicar_frm_form1').style.height='0px';
    document.getElementById('news_noticias_publicar_frm_form1').style.display='none';
    document.getElementById('news_noticias_publicar_frm_form1').style.overflow='scroll';
