<?php  
  ...
  session_start() ;
  class news_noticias_publicar_frm_form_teste
  {
   function news_noticias_publicar_frm_teste()
   {
...
<?php  
  ...
  $path_img     = $path_img . "news_noticias_publicar_frm/img";
...
?> 
<br> 
<B><FONT SIZE="4">news_noticias_publicar_frm</FONT></B> 
<br> 
<br> 
...
noticia_id&nbsp;&nbsp;<input type=text name=noticia_id size=20><br> 
<input type="submit" value="news_noticias_publicar_frm"> 
</form> 
<script language=javascript> 
 document.Fedit.noticia_id.focus(); 
</script> 
<br> 
</body> 
</html> 
<?php
  ...
  $frm_teste = new news_noticias_publicar_frm_form_teste();
  $frm_teste->news_noticias_publicar_frm_teste();
?>
