  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_news_noticias_publicar_frm_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_news_noticias_publicar_frm_mob_form();
	}
  ...
  function do_ajax_news_noticias_publicar_frm_mob_validate_categoria_id()
  {
    var nomeCampo_categoria_id = "categoria_id";
    var var_categoria_id = scAjaxGetFieldSelect(nomeCampo_categoria_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_mob_validate_categoria_id(var_categoria_id, var_script_case_init, do_ajax_news_noticias_publicar_frm_mob_validate_categoria_id_cb);
  } // do_ajax_news_noticias_publicar_frm_mob_validate_categoria_id

  function do_ajax_news_noticias_publicar_frm_mob_validate_categoria_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_mob_validate_categoria_id_cb

  // ---------- Validate noticia_data_noticia
  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_data_noticia()
  {
    ...
    setTimeout(function() {
      var var_noticia_data_noticia = scAjaxGetFieldText(nomeCampo_noticia_data_noticia);
      x_ajax_news_noticias_publicar_frm_mob_validate_noticia_data_noticia(var_noticia_data_noticia, var_script_case_init, do_ajax_news_noticias_publicar_frm_mob_validate_noticia_data_noticia_cb);
    }, 200);
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_data_noticia

  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_data_noticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_data_noticia_cb

  // ---------- Validate noticia_hora_noticia
  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_hora_noticia()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_mob_validate_noticia_hora_noticia(var_noticia_hora_noticia, var_script_case_init, do_ajax_news_noticias_publicar_frm_mob_validate_noticia_hora_noticia_cb);
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_hora_noticia

  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_hora_noticia_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_hora_noticia_cb

  // ---------- Validate noticia_flag_man_editorial
  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_flag_man_editorial()
  {
    var nomeCampo_noticia_flag_man_editorial = "noticia_flag_man_editorial";
    var var_noticia_flag_man_editorial = scAjaxGetFieldRadio(nomeCampo_noticia_flag_man_editorial);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_mob_validate_noticia_flag_man_editorial(var_noticia_flag_man_editorial, var_script_case_init, do_ajax_news_noticias_publicar_frm_mob_validate_noticia_flag_man_editorial_cb);
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_flag_man_editorial

  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_flag_man_editorial_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "noticia_flag_man_editorial";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_flag_man_editorial_cb

  // ---------- Validate noticia_titulo
  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_titulo()
  {
    var nomeCampo_noticia_titulo = "noticia_titulo";
    var var_noticia_titulo = scAjaxGetFieldText(nomeCampo_noticia_titulo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_mob_validate_noticia_titulo(var_noticia_titulo, var_script_case_init, do_ajax_news_noticias_publicar_frm_mob_validate_noticia_titulo_cb);
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_titulo

  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_titulo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_titulo_cb

  // ---------- Validate noticia_corpo
  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_corpo()
  {
    var nomeCampo_noticia_corpo = "noticia_corpo";
    var var_noticia_corpo = scAjaxGetFieldEditorHtml(nomeCampo_noticia_corpo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_mob_validate_noticia_corpo(var_noticia_corpo, var_script_case_init, do_ajax_news_noticias_publicar_frm_mob_validate_noticia_corpo_cb);
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_corpo

  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_corpo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_corpo_cb

  // ---------- Validate noticia_img
  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_img()
  {
    var nomeCampo_noticia_img = "noticia_img";
    var var_noticia_img = scAjaxGetFieldText(nomeCampo_noticia_img);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_news_noticias_publicar_frm_mob_validate_noticia_img(var_noticia_img, var_script_case_init, do_ajax_news_noticias_publicar_frm_mob_validate_noticia_img_cb);
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_img

  function do_ajax_news_noticias_publicar_frm_mob_validate_noticia_img_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_news_noticias_publicar_frm_mob_validate_noticia_img_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_news_noticias_publicar_frm_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_news_noticias_publicar_frm_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    var var_noticia_flag_man_editorial = scAjaxGetFieldRadio("noticia_flag_man_editorial");
    ...
    scAjaxProcOn();
    x_ajax_news_noticias_publicar_frm_mob_submit_form(var_categoria_id, var_noticia_data_noticia, var_noticia_hora_noticia, var_noticia_flag_man_editorial, var_noticia_titulo, var_noticia_corpo, var_noticia_img, var_noticia_id, var_noticia_img_ul_name, var_noticia_img_ul_type, var_noticia_img_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_news_noticias_publicar_frm_mob_submit_form_cb);
  } // do_ajax_news_noticias_publicar_frm_mob_submit_form

  function do_ajax_news_noticias_publicar_frm_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("noticia_flag_man_editorial");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_news_noticias_publicar_frm_mob_submit_form_cb_after_alert);
  } // do_ajax_news_noticias_publicar_frm_mob_submit_form_cb
  function do_ajax_news_noticias_publicar_frm_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_news_noticias_publicar_frm_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_news_noticias_publicar_frm_mob_navigate_form()
  {
    perform_ajax_news_noticias_publicar_frm_mob_navigate_form();
  }

  function perform_ajax_news_noticias_publicar_frm_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_news_noticias_publicar_frm_mob_navigate_form(var_noticia_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_news_noticias_publicar_frm_mob_navigate_form_cb);
  } // do_ajax_news_noticias_publicar_frm_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['news_noticias_publicar_frm_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_news_noticias_publicar_frm_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_news_noticias_publicar_frm_mob_navigate_form_cb_after_alert);
  } // do_ajax_news_noticias_publicar_frm_mob_navigate_form_cb
  function do_ajax_news_noticias_publicar_frm_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
{
?>
    do_ajax_news_noticias_publicar_frm_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_news_noticias_publicar_frm_mob_navigate_form_cb_after_alert
  function sc_hide_news_noticias_publicar_frm_mob_form()
  {
  ...
  ajax_field_list[3] = "noticia_flag_man_editorial";
  ajax_field_list[4] = "noticia_titulo";
  ajax_field_list[5] = "noticia_corpo";
  ajax_field_list[6] = "noticia_img";
  ...
  var ajax_error_list = {
    ...
    "noticia_flag_man_editorial": {"label": "Noticia Flag Man Editorial", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    ...
    "noticia_flag_man_editorial": new Array(),
  ...
  ajax_field_mult["noticia_flag_man_editorial"][1] = "noticia_flag_man_editorial";
  ...
  var ajax_field_id = {
    ...
    "noticia_flag_man_editorial": new Array("hidden_field_label_noticia_flag_man_editorial", "hidden_field_data_noticia_flag_man_editorial"),
  ...
  var ajax_read_only = {
    "categoria_id": "on",
    "noticia_data_noticia": "on",
    "noticia_hora_noticia": "on",
    "noticia_flag_man_editorial": "off",
    "noticia_titulo": "off",
    "noticia_corpo": "off",
    "noticia_img": "off"
  };
  ...
  function scAjaxDetailValue(sIndex, sValue)
  {
    ...
    if ("noticia_flag_man_editorial" == sIndex)
    {
